 ...
 *
 * @ORM\Table(name="nomenclador_especialidad")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\NomencladorEspecialidadRepository")
 */
class NomencladorEspecialidad
{
    /**
     * @var int
     *
     ...
     * @param string $nombre
     *
     * @return NomencladorEspecialidad
     */
