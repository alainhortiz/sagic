...
/**
 * NomencladorCategoriaDocente
 *
 * @ORM\Table(name="nomenclador_categoria_docente")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\NomencladorCategoriaDocenteRepository")
 */
class NomencladorCategoriaDocente
{
    /**
     * @var int
     *
     ...
     * @param string $nombre
     *
     * @return NomencladorCategoriaDocente
     */
