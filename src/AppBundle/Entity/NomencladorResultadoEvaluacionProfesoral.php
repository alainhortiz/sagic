...
/**
 * NomencladorResultadoEvaluacionProfesoral
 *
 * @ORM\Table(name="nomenclador_resultado_evaluacion_profesoral")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\NomencladorResultadoEvaluacionProfesoralRepository")
 */
class NomencladorResultadoEvaluacionProfesoral
{
    /**
     * @var int
     *
     ...
     * @param string $nombre
     *
     * @return NomencladorResultadoEvaluacionProfesoral
     */
