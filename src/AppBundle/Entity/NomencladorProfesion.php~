...
/**
 * NomencladorProfesion
 *
 * @ORM\Table(name="nomenclador_profesion")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\NomencladorProfesionRepository")
 */
class NomencladorProfesion
{
    /**
     * @var int
     *
