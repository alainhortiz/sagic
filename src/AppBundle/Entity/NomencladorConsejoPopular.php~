...
/**
 * NomencladorConsejoPopular
 *
 * @ORM\Table(name="nomenclador_consejo_popular")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\NomencladorConsejoPopularRepository")
 */
class NomencladorConsejoPopular
{
    /**
     * @var int
     *
     ...
     * @param string $nombre
     *
     * @return NomencladorConsejoPopular
     */
