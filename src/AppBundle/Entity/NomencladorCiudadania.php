...
/**
 * NomencladorCiudadania
 *
 * @ORM\Table(name="nomenclador_ciudadania")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\NomencladorCiudadaniaRepository")
 */
class NomencladorCiudadania
{
    /**
     * @var int
     *
