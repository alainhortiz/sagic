...
/**
 * NomencladorCategoriaCientifica
 *
 * @ORM\Table(name="nomenclador_categoria_cientifica")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\NomencladorCategoriaCientificaRepository")
 */
class NomencladorCategoriaCientifica
{
    /**
     * @var int
     *
     ...
     * @param string $nombre
     *
     * @return NomencladorCategoriaCientifica
     */
