...
/**
 * NomencladorMilitancia
 *
 * @ORM\Table(name="nomenclador_militancia")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\NomencladorMilitanciaRepository")
 */
class NomencladorMilitancia
{
    /**
     * @var int
     *
