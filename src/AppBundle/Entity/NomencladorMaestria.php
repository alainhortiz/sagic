 ...
 * NomencladorMaestria
 *
 * @ORM\Table(name="nomenclador_maestria")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\NomencladorMaestriaRepository")
 */
class NomencladorMaestria
{
    /**
     * @var int
     *
