...
(function (l) {
    ...
    (function (e) {
        var l = e.animObject, w = e.noop, x = e.color, y = e.defaultOptions, r = e.extend, D = e.format,
            z = e.objectEach, t = e.pick, n = e.Chart, p = e.seriesTypes, A = p.pie, p = p.column, B = e.Tick,
            u = e.fireEvent, C = 1;
        r(y.lang, {drillUpText: "\u25c1 Regresar a {series.name}"});
        y.drilldown = {
        ...
        n.prototype.drillUp = function () {
            if (this.drilldownLevels && 0 !== this.drilldownLevels.length) {
                for (var a = this, b = a.drilldownLevels, c = b[b.length - 1].levelNumber, d = b.length, f = a.series, h, g, e, k, q = function (b) {
                    ...
                    b.pop();
                    e = g.lowerSeries;
                    if (!e.chart) for (h = f.length; h--;) if (f[h].options.id === g.lowerSeriesOptions.id && f[h].options._levelNumber === c + 1) {
                        e = f[h];
                        break
                    }
                    e.xData = [];
        ...
        p.prototype.animateDrilldown = function (a) {
            var b = this, c = this.chart, d = c.drilldownLevels, f, e = l(c.options.drilldown.animation),
                g = this.xAxis, m = c.styledMode;
        ...
        p.prototype.animateDrillupFrom = function (a) {
            var b = l(this.chart.options.drilldown.animation), c = this.group, d = c !== this.chart.columnGroup,
                f = this;
            ...
            this.points.forEach(function (h) {
                var g = h.graphic, m = a.shapeArgs, k = function () {
                    g.destroy();
                    c && d && (c = c.destroy())
                };
                g && (delete h.graphic,
        ...
        A && r(A.prototype, {
            ...
            animateDrilldown: function (a) {
                var b = this.chart.drilldownLevels[this.chart.drilldownLevels.length - 1],
                    c = this.chart.options.drilldown.animation, d = b.shapeArgs, f = d.start,
                    h = (d.end - f) / this.points.length, g = this.chart.styledMode;
        ...
        B.prototype.drillable = function () {
            var a =
                    this.pos, b = this.label, c = this.axis, d = "xAxis" === c.coll && c.getDDPoints,
                f = d && c.getDDPoints(a), h = c.chart.styledMode;
        ...
        e.addEvent(e.Series, "afterDrawDataLabels", function () {
            ...
            this.points.forEach(function (d) {
                var f = d.options.dataLabels, e = t(d.dlOptions, f && f.style, {});
