...
(function (Q, H) {
    ...
    var H = function () {
        var a = "undefined" === typeof Q ? "undefined" !== typeof window ? window : {} : Q, B = a.document,
    ...
    (function (a) {
        a.timers = [];
        var B = a.charts, A = a.doc, G = a.win;
        ...
        a.Fx.prototype = {
            dSetter: function () {
                var a = this.paths[0], g = this.paths[1],
                    t = [], u = this.now, v = a.length, y;
                if (1 === u) t = this.toD; else if (v === g.length && 1 > u) for (; v--;) y = parseFloat(a[v]), t[v] = isNaN(y) ? g[v] : u * parseFloat(g[v] - y) + y; else t = g;
                this.elem.attr("d", t, null, !0)
            }, update: function () {
                var a = this.elem, g = this.prop, t = this.now, u = this.options.step;
                if (this[g + "Setter"]) this[g + "Setter"](); else a.attr ? a.element && a.attr(g, t, null, !0) : a.style[g] = t + this.unit;
                u && u.call(a, t, this)
            }, run: function (m, g, t) {
                var u = this, v = u.options, y = function (a) {
                ...
                var g = +new Date, t, u = this.options, v = this.elem,
                ...
                g = g || "";
                var q, f = m.startX, e = m.endX, p = -1 < g.indexOf("C"), r = p ? 7 : 3, b, l, n;
                g = g.split(" ");
                t = t.slice();
                var d = m.isArea, w = d ? 2 : 1, E;
                p && (u(g),
                    u(t));
                if (f && e) {
                    for (n = 0; n < f.length; n++) if (f[n] === e[0]) {
                        q = n;
                        break
        ...
        a.merge = function () {
            var m, g = arguments, t, u = {}, v = function (g, q) {
                "object" !== typeof g && (g =
                    {});
        ...
        a.pick = function () {
            var a = arguments, g, t, u = a.length;
            for (g = 0; g < u; g++) if (t = a[g],
        ...
        a.wrap = function (a, g, t) {
            var m = a[g];
            a[g] = function () {
                var a = Array.prototype.slice.call(arguments), g = arguments, q = this;
                q.proceed = function () {
        ...
        a.formatSingle = function (m, g, t) {
            var u = /\.([0-9])/, v = a.defaultOptions.lang;
        ...
        a.numberFormat = function (m, g, t, u) {
            m = +m || 0;
            g = +g;
            var v = a.defaultOptions.lang, y = (m.toString().split(".")[1] || "").split("e")[0].length,
                q, f, e = m.toString().split("e");
        ...
        a.offset = function (a) {
            ...
            return {
                top: a.top + (G.pageYOffset || g.scrollTop) -
                    (g.clientTop || 0), left: a.left + (G.pageXOffset || g.scrollLeft) - (g.clientLeft || 0)
            }
        };
        a.stop = function (m, g) {
        ...
        a.seriesType = function (m, g, t, u, v) {
            var y = a.getOptions(), q = a.seriesTypes;
    ...
    (function (a) {
        var B = a.isNumber, A = a.merge, G = a.pInt;
        a.Color = function (m) {
        ...
        a.Color.prototype = {
            ...
            init: function (m) {
                ...
                }); else if (m && m.charAt && "#" === m.charAt() && (g = m.length, m = parseInt(m.substr(1), 16), 7 === g ? t = [(m & 16711680) >> 16, (m & 65280) >> 8, m & 255, 1] : 4 === g && (t = [(m & 3840) >> 4 | (m & 3840) >> 8, (m & 240) >> 4 | m & 240, (m & 15) << 4 | m & 15, 1])), !t) for (u = this.parsers.length; u-- && !t;) v = this.parsers[u], (g = v.regex.exec(m)) && (t = v.parse(g));
                this.rgba = t || []
            }, get: function (a) {
                var g = this.input,
                    m = this.rgba, u;
                ...
                if (this.stops) this.stops.forEach(function (g) {
                    g.brighten(a)
                }); else if (B(a) && 0 !== a) for (g = 0; 3 > g; g++) m[g] += G(255 * a), 0 > m[g] && (m[g] = 0), 255 < m[g] && (m[g] = 255);
                return this
    ...
    (function (a) {
        var B, A, G = a.addEvent, m = a.animate, g = a.attr, t = a.charts, u = a.color, v = a.css, y = a.createElement,
            q = a.defined, f = a.deg2rad, e = a.destroyObjectProperties, p = a.doc,
            r = a.extend, b = a.erase, l = a.hasTouch, n = a.isArray, d = a.isFirefox, w = a.isMS, E = a.isObject,
            C = a.isString, F = a.isWebKit, c = a.merge, k = a.noop, x = a.objectEach, D = a.pick, h = a.pInt,
            z = a.removeEvent, L = a.splat, J = a.stop, W = a.svg, I = a.SVG_NS, O = a.symbolSizes, R = a.win;
        ...
        r(B.prototype, {
            ...
            complexColor: function (h, b, k) {
                var z = this.renderer, K, l, d, e, r, f, w, p, I, D, J, L = [], E;
                a.fireEvent(this.renderer, "complexColor",
                    {args: arguments}, function () {
                        ...
                        }), "radialGradient" === l && D && !q(d.gradientUnits) && (e = d, d = c(d, z.getRadialAttr(D, e), {gradientUnits: "userSpaceOnUse"})), x(d, function (a, h) {
                            "id" !== h && L.push(h, a)
                        }), x(w, function (a) {
                            L.push(a)
                ...
                if ((K = h[0]) && "none" !== K && a.svg) {
                    ...
                    h.forEach(function (a, h) {
                        ...
                        g(a, {
                            ...
                            fill: z, stroke: z, "stroke-width": K, "stroke-linejoin": "round"
                        });
                        c.insertBefore(a, l)
                    })
                }
            ...
            attr: function (h, c, b, k) {
                var z, K = this.element, d, l = this, n, e, r = this.symbolCustomAttribs;
            ...
            css: function (a) {
                var c = this.styles, b = {}, k = this.element, z, d = "", l, n = !c, K = ["textOutline", "textOverflow",
                    "width"];
            ...
            strokeWidth: function () {
                ...
                var a = this.getStyle("stroke-width"), c;
            ...
            updateTransform: function () {
                var a = this.translateX || 0, h = this.translateY || 0, c = this.scaleX, b = this.scaleY,
                    k = this.inverted, z = this.rotation, d = this.matrix, l = this.element;
            ...
            getBBox: function (a, h) {
                var c, b = this.renderer, k, z = this.element, d = this.styles, l, x = this.textStr, n, e = b.cache,
                    K = b.cacheKeys, w = z.namespaceURI === this.SVG_NS,
                    p;
                h = D(h, this.rotation);
                k = h * f;
            ...
            add: function (a) {
                var h = this.renderer, c = this.element, b;
            ...
            destroy: function () {
                var a =
                        this, h = a.element || {}, c = a.renderer, k = c.isSVG && "SPAN" === h.nodeName && a.parentGroup,
                    z = h.ownerSVGElement, d = a.clipPath;
                ...
                d && z && ([].forEach.call(z.querySelectorAll("[clip-path],[CLIP-PATH]"), function (a) {
                    var h = a.getAttribute("clip-path"), c = d.element.id;
            ...
            shadow: function (a, h, c) {
                var b = [], k, z, d = this.element, l, x, n, e;
            ...
            zIndexSetter: function (a, c) {
                var b = this.renderer, k = this.parentGroup, z = (k || b).element || b.box, d, l = this.element, x, n,
                    b = z === b.box;
                d = this.added;
                var e;
                ...
                if (d) {
                    ...
                    c = z.childNodes;
                    for (e = c.length -
                        1; 0 <= e && !x; e--) if (k = c[e], d = k.getAttribute("data-z-index"), n = !q(d), k !== l) if (0 > a && n && !b && !e) z.insertBefore(l, c[e]), x = !0; else if (h(d) <= a || n && (!q(a) || 0 <= a)) z.insertBefore(l, c[e + 1] || null), x = !0;
        ...
        r(A.prototype, {
            ...
            definition: function (a) {
                function h(a, b) {
                    ...
                    L(a).forEach(function (a) {
                        var z = c.createElement(a.tagName), d = {};
                        x(a, function (a, h) {
            ...
            truncate: function (a, h, c, b, k,
                                z, d) {
                var l = this, x = a.rotation, n, e = b ? 1 : 0, r = (c || b).length, f = r, w = [], I = function (a) {
                    h.firstChild && h.removeChild(h.firstChild);
            ...
            buildText: function (a) {
                var c = a.element, b = this, k = b.forExport, z = D(a.textStr, "").toString(),
                    d = -1 !== z.indexOf("\x3c"), l = c.childNodes, n, e = g(c, "x"), r = a.styles, f = a.textWidth,
                    w = r && r.lineHeight, q = r && r.textOutline, J = r && "ellipsis" === r.textOverflow,
                    L = r && "nowrap" === r.whiteSpace, E = r && r.fontSize, K, C, F = l.length, r = f && !a.added &&
                    this.box, O = function (a) {
                        var k;
                            ...
                            if ("" !== h || 1 === d.length) {
                                ...
                                if (" " !== h) {
                                    ...
                                    if (f) {
                                        ...
                                        }); else if (r) for (; K.length;) K.length &&
            ...
            button: function (a, h, b, k, z, d, l, x, n) {
                var e = this.label(a, h, b, n, null, null, null, null, "button"), f = 0, p = this.styledMode;
            ...
            arc: function (a, h, c, b, k, z) {
                E(a) ? (b = a, h = b.y, c =
                    b.r, a = b.x) : b = {innerR: b, start: k, end: z};
            ...
            image: function (a, h, c, b, k, z) {
                var d = {preserveAspectRatio: "none"}, l, x = function (a, h) {
            ...
            symbol: function (a, h, c, b, k, z) {
                var d = this, l, x = /^url\((.*?)\)$/, n = x.test(a), e = !n && (this.symbols[a] ? a : "circle"),
                    f = e && this.symbols[e],
                    w = q(h) && f && f.call(this.symbols, Math.round(h), Math.round(c), b, k, z), I, J;
                f ? (l = this.path(w), d.styledMode || l.attr("fill", "none"), r(l, {
                    symbolName: e, x: h,
                    y: c, width: b, height: k
                    ...
                    l[a + "Setter"] = function (a, h) {
                        var c = {}, b = this["img" + h], k = "width" === h ? "translateX" : "translateY";
                        this[h] = a;
                        q(b) && (this.element && this.element.setAttribute(h, b), this.alignByTranslate || (c[k] = ((this[h] || 0) - b) / 2, this.attr(c)))
                    }
                }), q(h) && l.attr({x: h, y: c}), l.isImg =
                    !0, q(l.imgwidth) && q(l.imgheight) ? J() : (l.attr({
                    width: 0,
                    height: 0
                }), y("img", {
                    onload: function () {
            ...
            symbols: {
                circle: function (a, h, c, b) {
                    return this.arc(a + c / 2, h +
                        b / 2, c / 2, b / 2, {start: 0, end: 2 * Math.PI, open: !1})
                    ...
                    var z = k.start, d = k.r || c, l = k.r || b || c, x = k.end - .001;
                    c = k.innerR;
                    b = D(k.open, .001 > Math.abs(k.end - k.start - 2 * Math.PI));
                    var n = Math.cos(z), e = Math.sin(z),
                        r = Math.cos(x), x = Math.sin(x);
                    ...
                    var z = Math.min(k && k.r || 0, c, b), d = z + 6, l = k && k.anchorX;
                    k = k && k.anchorY;
                    var x;
            ...
            clipRect: function (h, c, b, k) {
                var z = a.uniqueKey(), l = this.createElement("clipPath").attr({id: z}).add(this.defs);
            ...
            text: function (a, h, c, b) {
                ...
                b || (a.xSetter = function (a, h, c) {
                    var b = c.getElementsByTagName("tspan"), k, z = c.getAttribute(h), l;
            ...
            label: function (h, b, k, l, d, x, n, e, f) {
                var w = this, p = w.styledMode, I = w.g("button" !== f && "label"),
                    D = I.text = w.text("", 0, 0, n).attr({zIndex: 1}), J, L, E = 0, g = 3, C = 0, F, W, O, m, y,
                    R = {}, v, t, K = /^url\((.*?)\)$/.test(l), u = p || K, S = function () {
                        return p ? J.strokeWidth() %
                            2 / 2 : (v ? parseInt(v, 10) : 0) % 2 / 2
                    }, aa, A, T;
                f && I.addClass("highcharts-" + f);
                aa = function () {
                    var a = D.element.style, h = {};
                ...
                A = function () {
                    var a = C + g, h;
                    h = e ? 0 : t;
                    q(F) && L && ("center" === y || "right" === y) && (a += {center: .5, right: 1}[y] * (F - L.width));
    ...
    (function (a) {
        var B = a.attr, A = a.createElement, G = a.css, m = a.defined, g = a.extend, t = a.isFirefox, u = a.isMS,
            v = a.isWebKit, y = a.pick, q = a.pInt, f = a.SVGElement, e = a.SVGRenderer, p = a.win;
        g(f.prototype, {
            htmlCss: function (a) {
                var b = "SPAN" === this.element.tagName && a && "width" in a, l = y(b && a.width, void 0), n;
                ...
                if (this.added) {
                    var a = this.renderer,
                        b = this.element, l = this.translateX || 0, n = this.translateY || 0, d = this.x || 0,
                        e = this.y || 0, f = this.textAlign || "left", p = {left: 0, center: .5, right: 1}[f],
                        g = this.styles, c = g && g.whiteSpace;
                    ...
                    if ("SPAN" === b.tagName) {
                        var g = this.rotation, k = this.textWidth && q(this.textWidth),
                ...
                var n = {}, d = this.renderer.getTransformKey();
        ...
        g(e.prototype, {
            getTransformKey: function () {
                ...
                var n = this.createElement("span"), d = n.element, w = n.renderer, r = w.isSVG, p = function (a, b) {
                    ...
                    a.addedSetters = !0
                }, q = a.charts[w.chartIndex], q = q && q.styledMode;
                            ...
                            l.reverse().forEach(function (a) {
                                ...
                                g(a, {
                                    classSetter: function (a) {
                                        ...
                                        l[0].div &&
                                        n.on.apply({element: l[0].div}, arguments);
                                        return a
    ...
    (function (a) {
        var B = a.defined, A = a.extend, G = a.merge, m = a.pick, g = a.timeUnits, t = a.win;
        a.Time = function (a) {
            this.update(a, !1)
        };
        a.Time.prototype = {
            defaultOptions: {}, update: function (a) {
                var g = m(a && a.useUTC, !0), y = this;
                ...
                (this.variableTimezone = !(g && !a.getTimezoneOffset && !a.timezone)) || this.timezoneOffset ? (this.get = function (a, f) {
                    var e = f.getTime(), p = e - y.getTimezoneOffset(f);
                    f.setTime(p);
                    a = f["getUTC" + a]();
                    f.setTime(e);
                    return a
                    ...
                    var p;
                    if ("Milliseconds" === a || "Seconds" === a || "Minutes" === a && 0 === f.getTimezoneOffset() % 60) f["set" + a](e); else p = y.getTimezoneOffset(f), p = f.getTime() - p, f.setTime(p), f["setUTC" + a](e), a = y.getTimezoneOffset(f),
                ...
                var g = this, m = this.options, y = t.moment;
                ...
                var q = this, f = new this.Date(m), e = this.get("Hours", f), p = this.get("Day", f),
                    r = this.get("Date", f), b = this.get("Month", f), l = this.get("FullYear", f),
                    n = a.defaultOptions.lang, d = n.weekdays, w = n.shortWeekdays, E = a.pad, f = a.extend({
                ...
                var f = this, e = [], p, r = {}, b;
                p = new f.Date(t);
                var l = a.unitRange, n = a.count || 1, d;
                q = m(q, 1);
                if (B(t)) {
                    ...
                    b = f.get("FullYear",
                        p);
                    q = f.get("Month", p);
                    var w = f.get("Date", p), E = f.get("Hours", p);
                    t = p.getTime();
                ...
                e.info =
                    A(a, {higherRanks: r, totalRange: l * n});
                return e
            }
        }
    })(H);
    (function (a) {
        var B = a.color, A = a.merge;
        a.defaultOptions = {
    ...
    (function (a) {
        var B = a.correctFloat, A = a.defined, G = a.destroyObjectProperties, m = a.fireEvent, g = a.isNumber,
            t = a.merge, u = a.pick, v = a.deg2rad;
        ...
        a.Tick.prototype = {
            addLabel: function () {
                var g = this,
                    q = g.axis, f = q.options, e = q.chart, p = q.categories, r = q.names, b = g.pos,
                    l = u(g.options && g.options.labels, f.labels), n = q.tickPositions, d = b === n[0],
                    w = b === n[n.length - 1], p = this.parameters.category || (p ? u(p[b], r[b], b) : b), E = g.label,
                    n = n.info, C, F, c, k;
                ...
                if (k = F && F.list) g.shortenLabel = function () {
                    for (c = 0; c < k.length; c++) if (E.attr({text: q.labelFormatter.call(a.extend(g.formatCtx, {dateTimeLabelFormat: k[c]}))}), E.getBBox().width < q.getSlotWidth(g) - 2 * u(l.padding, 5)) return;
                    E.attr({text: ""})
                };
                if (A(E)) E && E.textStr !== f && (!E.textWidth || l.style && l.style.width || E.styles.width || E.css({width: null}), E.attr({text: f})); else {
                ...
                var q = this.axis, f = q.options.labels, e = a.x, p = q.chart.chartWidth, r = q.chart.spacing,
                    b = u(q.labelLeft, Math.min(q.pos, r[3])),
                    r = u(q.labelRight, Math.max(q.isRadial ? 0 : q.pos + q.len, p - r[1])), l = this.label,
                    n = this.rotation, d = {left: 0, center: .5, right: 1}[q.labelAlign || l.attr("align")],
                    w = l.getBBox().width, g = q.getSlotWidth(this),
                    C = g, F = 1, c, k = {};
                ...
                c && (this.shortenLabel ? this.shortenLabel() : (k.width = Math.floor(c), (f.style || {}).textOverflow || (k.textOverflow = "ellipsis"), l.css(k)))
                                      ...
                                      q, f, e) {
                var p = this.axis, r = p.chart, b = e && r.oldChartHeight || r.chartHeight;
                g = {
                ...
                var n = this.axis, d = n.transA, w = n.reversed, g = n.staggerLines, C = n.tickRotCorr || {x: 0, y: 0},
                    F = p.y, c = e || n.reserveSpaceDefault ?
                    0 : -n.labelOffset * ("center" === n.labelAlign ? .5 : 1), k = {};
                ...
                return r.crispLine(["M", a, q, "L", a + (p ? 0 : -f), q + (p ? f : 0)], e)
                                         ...
                                         q, f) {
                var e = this.axis, p = e.options, r = this.gridLine, b = {}, l = this.pos, n = this.type,
                    d = u(this.tickmarkOffset, e.tickmarkOffset), w = e.chart.renderer, g = n ? n + "Grid" : "grid",
                    C = p[g + "LineWidth"], F = p[g + "LineColor"], p = p[g + "LineDashStyle"];
                ...
                if (r && (f = e.getPlotLinePath(l + d, r.strokeWidth() * f, a, "pass"))) r[a || this.isNew ? "attr" :
                    "animate"]({d: f, opacity: q})
            }, renderMark: function (a, q, f) {
                var e = this.axis, p = e.options, r = e.chart.renderer, b = this.type, l = b ? b + "Tick" : "tick",
                    n = e.tickSize(l), d = this.mark, w = !d, g = a.x;
                a = a.y;
                var C = u(p[l + "Width"], !b && e.isXAxis ? 1 : 0), p = p[l + "Color"];
            ...
            renderLabel: function (a, q, f, e) {
                var p = this.axis, r = p.horiz, b = p.options, l = this.label, n = b.labels, d = n.step,
                    p = u(this.tickmarkOffset, p.tickmarkOffset), w = !0, E = a.x;
                a = a.y;
                ...
                var e = this.axis, p = e.horiz, r = this.pos, b = u(this.tickmarkOffset, e.tickmarkOffset),
                    r = this.getPosition(p, r, b, q), b = r.x, l = r.y,
    ...
    var da = function (a) {
        var B = a.addEvent, A = a.animObject, G = a.arrayMax, m = a.arrayMin, g = a.color, t = a.correctFloat,
            u = a.defaultOptions,
            v = a.defined, y = a.deg2rad, q = a.destroyObjectProperties, f = a.extend, e = a.fireEvent, p = a.format,
            r = a.getMagnitude, b = a.isArray, l = a.isNumber, n = a.isString, d = a.merge, w = a.normalizeTickInterval,
            E = a.objectEach, C = a.pick, F = a.removeEvent, c = a.splat, k = a.syncTimeout, x = a.Tick,
            D = function () {
        ...
        a.extend(D.prototype, {
            ...
            defaultLabelFormatter: function () {
                var h = this.axis, c = this.value, b = h.chart.time, k = h.categories, l = this.dateTimeLabelFormat,
                    d = u.lang, x = d.numericSymbols,
                    d = d.numericSymbolMagnitude || 1E3, n = x && x.length, e, f = h.options.labels.format,
                    h = h.isLog ? Math.abs(c) : h.tickInterval;
                if (f) e = p(f, this, b); else if (k) e = c; else if (l) e = b.dateFormat(l, c); else if (n && 1E3 <= h) for (; n-- && void 0 === e;) b = Math.pow(d, n + 1), h >= b && 0 === 10 * c % b && null !== x[n] && 0 !== c && (e = a.numberFormat(c / b, -1) + x[n]);
                ...
                e(this, "getSeriesExtremes", null, function () {
                    ...
                    a.series.forEach(function (h) {
                        if (h.visible || !c.options.chart.ignoreHiddenSeries) {
                            var b = h.options, k = b.threshold, z;
                            a.hasVisibleSeries = !0;
                            a.positiveValuesOnly && 0 >= k && (k = null);
                            if (a.isXAxis) b = h.xData, b.length && (h = m(b), z = G(b), l(h) || h instanceof Date || (b = b.filter(l), h = m(b), z = G(b)), b.length && (a.dataMin = Math.min(C(a.dataMin, b[0], h), h), a.dataMax = Math.max(C(a.dataMax, b[0], z), z))); else if (h.getExtremes(), z = h.dataMax,
            ...
            translate: function (a, c, b, k, d, x) {
                var h = this.linkedParent || this, z = 1, n = 0, e = k ? h.oldTransA : h.transA;
                k = k ? h.oldMin : h.min;
            ...
            getPlotLinePath: function (a, c, b, k, d) {
                var h = this, z = h.chart, x = h.left, n = h.top, f, w, r, p,
                    D = b && z.oldChartHeight || z.chartHeight, q = b && z.oldChartWidth || z.chartWidth, g,
                    L = h.transB, E, J = function (a, h, c) {
            ...
            getMinorTickPositions: function () {
                var a = this, c = a.options, b = a.tickPositions, k = a.minorTickInterval, d = [],
                    l = a.pointRangePadding || 0, x = a.min - l, l = a.max + l, n = l - x;
                if (n && n / k < a.len / 3) if (a.isLog) this.paddedTicks.forEach(function (h, c, b) {
                    c && d.push.apply(d,
                        a.getLogTickPositions(k, b[c - 1], b[c], !0))
                }); else if (a.isDatetimeAxis && "auto" === this.getMinorTickInterval()) d = d.concat(a.getTimeTicks(a.normalizeTimeTickInterval(k), x, l, c.startOfWeek)); else for (c = x + (b[0] - x) % k; c <= l && c !== d[0]; c += k) d.push(c);
                0 !== d.length && a.trimTicks(d);
                return d
            },
            adjustForMinRange: function () {
                var a = this.options, c = this.min, b = this.max, k, d, l, x, n, e, f, w;
                this.isXAxis && void 0 === this.minRange && !this.isLog && (v(a.min) || v(a.max) ? this.minRange = null : (this.series.forEach(function (a) {
                    e = a.xData;
                    for (x =
                             f = a.xIncrement ? 1 : e.length - 1; 0 < x; x--) if (n = e[x] - e[x - 1], void 0 === l || n < l) l = n
            ...
            getClosest: function () {
                ...
                this.categories ?
                    a = 1 : this.series.forEach(function (h) {
                        var c = h.closestPointRange, b = h.visible || !h.chart.options.chart.ignoreHiddenSeries;
                        !h.noSharedTooltip && v(c) && b && (a = v(a) ? Math.min(a, c) : c)
                    });
                return a
            },
            nameToX: function (a) {
                var h = b(this.categories), c = h ? this.categories : this.names, k = a.options.x, d;
            ...
            setAxisTranslation: function (a) {
                var h = this, c = h.max -
                    h.min, b = h.axisPointRange || 0, k, d = 0, l = 0, x = h.linkedParent, f = !!h.categories,
                    w = h.transA, r = h.isXAxis;
            ...
            setTickInterval: function (h) {
                var c = this, b = c.chart, k = c.options, d = c.isLog, x = c.isDatetimeAxis, n = c.isXAxis,
                    f = c.isLinked, p = k.maxPadding, D = k.minPadding, g, q = k.tickInterval, E = k.tickPixelInterval,
                    F = c.categories, m = l(c.threshold) ? c.threshold : null, y = c.softThreshold, u, A, B;
            ...
            setTickPositions: function () {
                var c = this.options, k, b = c.tickPositions;
                k = this.getMinorTickInterval();
                var d = c.tickPositioner, l = c.startOnTick, x = c.endOnTick;
                ...
                !k && (!this.ordinalPositions && (this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200) ? (k = [this.min, this.max], a.error(19, !1, this.chart)) : k = this.isDatetimeAxis ? this.getTimeTicks(this.normalizeTimeTickInterval(this.tickInterval, c.units), this.min, this.max, c.startOfWeek, this.ordinalPositions, this.closestPointRange, !0) : this.isLog ? this.getLogTickPositions(this.tickInterval, this.min, this.max) : this.getLinearTickPositions(this.tickInterval, this.min, this.max), k.length > this.len && (k = [k[0],
                    k.pop()], k[0] === k[1] && (k.length = 1)), this.tickPositions = k, d && (d = d.apply(this, [this.min, this.max]))) && (this.tickPositions = k = d);
            ...
            trimTicks: function (a, c, k) {
                var h = a[0], b = a[a.length - 1], d = this.minPointOffset || 0;
                e(this, "trimTicks");
                if (!this.isLinked) {
                    if (c && -Infinity !== h) this.min = h; else for (; this.min - d > a[0];) a.shift();
                    if (k) this.max =
                        b; else for (; this.max + d < a[a.length - 1];) a.pop();
                    0 === a.length && v(h) && !this.options.tickPositions && a.push((b + h) / 2)
                }
            },
            alignToOthers: function () {
                var a = {}, c, k = this.options;
            ...
            getTickAmount: function () {
                var a = this.options, c = a.tickAmount, k = a.tickPixelInterval;
            ...
            adjustTickAmount: function () {
                var a = this.options, c = this.tickInterval, k = this.tickPositions, b = this.tickAmount,
                    d = this.finalTickAmt, l = k && k.length, x = C(this.threshold, this.softThreshold ? 0 : null), n;
                if (this.hasData()) {
                    if (l < b) {
            ...
            zoom: function (a, c) {
                var h = this.dataMin, k = this.dataMax, b = this.options, d = Math.min(h, C(b.min, h)),
                    l = Math.max(k, C(b.max, k));
                a = {newMin: a, newMax: c};
                e(this, "zoom", a, function (a) {
                    var c = a.newMin, b = a.newMax;
                    if (c !== this.min || b !== this.max) this.allowZoomOutside || (v(h) && (c < d && (c = d), c > l && (c = l)), v(k) && (b < d && (b = d), b > l && (b = l))), this.displayBtn = void 0 !==
                        c || void 0 !== b, this.setExtremes(c, b, !1, void 0, {trigger: "zoom"});
                    a.zoomed = !0
                });
                return a.zoomed
            },
            setAxisSize: function () {
                var c = this.chart, k = this.options, b = k.offsets || [0, 0, 0, 0], d = this.horiz,
            ...
            getThreshold: function (a) {
                var c = this.isLog, h = c ? this.lin2log(this.min) : this.min,
            ...
            tickSize: function (a) {
                var c = this.options, h = c[a + "Length"], k = C(c[a + "Width"], "tick" === a && this.isXAxis ? 1 : 0),
                    b;
            ...
            unsquish: function () {
                var a = this.options.labels, c = this.horiz, k = this.tickInterval, b = k,
                    d = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / k), l, x = a.rotation,
                    n = this.labelMetrics(), e, f = Number.MAX_VALUE, w, r = this.max - this.min, p = function (a) {
                        var c = a / (d || 1), c = 1 < c ? Math.ceil(c) : 1;
            ...
            getSlotWidth: function (a) {
                var c = this.chart, h = this.horiz, k = this.options.labels,
                    b = Math.max(this.tickPositions.length - (this.categories ? 0 : 1), 1), d = c.margin[3];
            ...
            renderUnsquish: function () {
                var a = this.chart, c = a.renderer, k = this.tickPositions, b = this.ticks, d = this.options.labels,
                    l = d && d.style || {}, x = this.horiz, e = this.getSlotWidth(),
                    f = Math.max(1, Math.round(e - 2 * (d.padding || 5))), w = {}, r = this.labelMetrics(),
                    p = d.style && d.style.textOverflow, D, g, q = 0, E;
                ...
                if (this.autoRotation) q > f && q > r.h ? w.rotation = this.labelRotation : this.labelRotation = 0; else if (e && (D = f, !p)) for (g = "clip", f = k.length; !x && f--;) if (E = k[f], E = b[E].label) E.styles && "ellipsis" === E.styles.textOverflow ? E.css({textOverflow: "clip"}) : E.textPxLength > e && E.css({width: e + "px"}), E.getBBox().height > this.len / k.length - (r.h - r.f) && (E.specificTextOverflow = "ellipsis");
                ...
                k.forEach(function (a) {
                    var c = (a = b[a]) && a.label, h = l.width, k = {};
                    c && (c.attr(w), a.shortenLabel ? a.shortenLabel() : D && !h && "nowrap" !== l.whiteSpace && (D < c.textPxLength || "SPAN" === c.element.tagName) ? (k.width = D, p || (k.textOverflow = c.specificTextOverflow || g), c.css(k)) : c.styles && c.styles.width && !k.width && !h && c.css({width: null}), delete c.specificTextOverflow, a.rotation = w.rotation)
                }, this);
            ...
            addTitle: function (a) {
                var c = this.chart.renderer, h = this.horiz, k = this.opposite, b = this.options.title, l,
            ...
            getOffset: function () {
                var a = this, c = a.chart, k = c.renderer, b = a.options, d = a.tickPositions, l = a.ticks, x = a.horiz,
                    n = a.side, f = c.inverted && !a.isZAxis ? [1, 0, 3, 2][n] : n, w, r, p = 0, D, q = 0, g = b.title,
                    F = b.labels, m = 0, t = c.axisOffset, c = c.clipOffset,
                    y = [-1, 1, 1, -1][n], u = b.className, A = a.axisParent;
                w = a.hasData();
            ...
            getLinePath: function (a) {
                var c = this.chart, k = this.opposite, h = this.offset, b = this.horiz,
            ...
            getTitlePosition: function () {
                var a = this.horiz, c = this.left, k = this.top, b = this.len, d = this.options.title, l = a ? c : k,
                    x = this.opposite, n = this.offset, f = d.x || 0, w = d.y || 0, r = this.axisTitle,
                    ...
                    c = (a ? k + this.height : c) + (a ? 1 : -1) * (x ? -1 : 1) * this.axisTitleMargin +
                        [-r, r, p.f, -r][this.side], a = {
            ...
            renderMinorTick: function (a) {
                var c = this.chart.hasRendered && l(this.oldMin), k = this.minorTicks;
                k[a] || (k[a] = new x(this, a, "minor"));
                c && k[a].isNew && k[a].render(null, !0);
                k[a].render(null, !1, 1)
            },
            renderTick: function (a, c) {
                var k = this.isLinked, b = this.ticks, h = this.chart.hasRendered && l(this.oldMin);
                if (!k || a >= this.min && a <= this.max) b[a] || (b[a] = new x(this, a)), h && b[a].isNew &&
                b[a].render(c, !0, -1), b[a].render(c)
            },
            render: function () {
                var c = this, b = c.chart, d = c.options, n = c.isLog, f = c.isLinked, w = c.tickPositions,
                    r = c.axisTitle, p = c.ticks, D = c.minorTicks, q = c.alternateBands, g = d.stackLabels,
                    C = d.alternateGridColor, F = c.tickmarkOffset, m = c.axisLine, t = c.showAxis,
                    y = A(b.renderer.globalAnimation), v, u;
                ...
                m && (m[m.isPlaced ? "animate" : "attr"]({d: this.getLinePath(m.strokeWidth())}), m.isPlaced = !0, m[t ? "show" : "hide"](!0));
            ...
            destroy: function (a) {
                var c = this, k = c.stacks, b = c.plotLinesAndBands, h;
            ...
            drawCrosshair: function (a, c) {
                var k, b = this.crosshair, h = C(b.snap, !0), d, l = this.cross;
                ...
                if (this.crosshair && !1 !== (v(c) || !h)) {
                    ...
                    l || (this.cross = l = this.chart.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (h ? "category " : "thin ") + b.className).attr({zIndex: C(b.zIndex, 2)}).add(), this.chart.styledMode || (l.attr({
                        stroke: b.color ||
                            (h ? g("#ccd6eb").setOpacity(.25).get() : "#cccccc"), "stroke-width": C(b.width, 1)
                    }).css({"pointer-events": "none"}), b.dashStyle && l.attr({dashstyle: b.dashStyle})));
                    l.show().attr({d: k});
    ...
    (function (a) {
        var B = a.Axis, A = a.getMagnitude, G = a.normalizeTickInterval, m = a.timeUnits;
    ...
    (function (a) {
        var B = a.Axis, A = a.getMagnitude, G = a.normalizeTickInterval, m = a.pick;
        B.prototype.getLogTickPositions = function (a, t, u, v) {
            var g = this.options, q = this.len, f = [];
            v || (this._minorAutoInterval = null);
            if (.5 <= a) a = Math.round(a), f = this.getLinearTickPositions(a, t, u); else if (.08 <= a) for (var q = Math.floor(t), e, p, r, b, l, g = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; q < u + 1 && !l; q++) for (p =
                                                                                                                                                                                                                                                                     g.length, e = 0; e < p && !l; e++) r = this.log2lin(this.lin2log(q) * g[e]), r > t && (!v || b <= u) && void 0 !== b && f.push(b), b > u && (l = !0), b = r; else t = this.lin2log(t), u = this.lin2log(u), a = v ? this.getMinorTickInterval() : g.tickInterval, a = m("auto" === a ? null : a, this._minorAutoInterval, g.tickPixelInterval / (v ? 5 : 1) * (u - t) / ((v ? q / this.tickPositions.length : q) || 1)), a = G(a, null, A(a)), f = this.getLinearTickPositions(a, t, u).map(this.log2lin), v || (this._minorAutoInterval = a / 5);
    ...
    (function (a, B) {
        var A = a.arrayMax, G = a.arrayMin, m = a.defined, g = a.destroyObjectProperties, t = a.erase, u = a.merge,
            v = a.pick;
        ...
        a.PlotLineOrBand.prototype = {
            render: function () {
                ...
                var g = this, q = g.axis, f = q.horiz, e = g.options, p = e.label, r = g.label, b = e.to, l = e.from,
                    n = e.value, d = m(l) && m(b), w = m(n), E = g.svgElem, C = !E, F = [], c = e.color,
                    k = v(e.zIndex, 0), x = e.events,
                    F = {"class": "highcharts-plot-" + (d ? "band " : "line ") + (e.className || "")}, D = {},
                    h = q.chart.renderer, z = d ? "bands" : "lines";
                ...
                C && F && F.length ? (E.attr({d: F}), x && a.objectEach(x, function (a, c) {
                    E.on(c, function (a) {
                        x[c].apply(g, [a])
                    })
                ...
                return g
                                      ...
                                      q, f, e) {
                var p = this.label, r = this.axis.chart.renderer;
                p || (p = {
        ...
        a.extend(B.prototype, {
            getPlotBandPath: function (a, q) {
                var f = this.getPlotLinePath(q, null, null, !0), e = this.getPlotLinePath(a, null, null, !0), p = [],
                    r = this.horiz, b = 1, l;
                a = a < this.min && q < this.min || a > this.max && q > this.max;
                if (e && f) for (a && (l = e.toString() === f.toString(), b = 0), a = 0; a < e.length; a += 6) r && f[a + 1] === e[a + 1] ? (f[a + 1] += b, f[a + 4] += b) : r || f[a + 2] !== e[a + 2] || (f[a + 2] += b, f[a + 5] += b), p.push("M", e[a + 1], e[a + 2], "L", e[a + 4], e[a + 5], f[a + 4], f[a + 5], f[a + 1], f[a + 2], "z"), p.isFlat = l;
                return p
                ...
                var f = (new a.PlotLineOrBand(this, g)).render(), e = this.userOptions;
    ...
    (function (a) {
        var B = a.doc, A = a.extend, G = a.format, m = a.isNumber, g = a.merge, t = a.pick, u = a.splat,
            v = a.syncTimeout, y = a.timeUnits;
        a.Tooltip = function () {
            this.init.apply(this, arguments)
        };
        a.Tooltip.prototype = {
            init: function (a, f) {
                ...
                var q = this, f = this.chart.renderer, e = this.chart.styledMode, p = this.options, r, b;
                ...
                var e = this.chart, p = e.pointer, r = e.inverted, b = e.plotTop, l = e.plotLeft, n = 0, d = 0, w, g;
                a = u(a);
                ...
                var p = this.chart, r = this.distance, b = {}, l = p.inverted && e.h || 0, n, d = this.outside,
                    ...
                    x = function (a, c, h, d, x, n) {
                        var e = h < d - r, f = d + r + h < c, w = d - r - h;
                        d += r;
                        if (k && f) b[a] = d; else if (!k && e) b[a] = w; else if (e) b[a] = Math.min(n - h, 0 > w - l ? w : w - l); else if (f) b[a] = Math.max(x, d + l + h > c ? d : d + l); else return !1
                    }, D = function (a, c, k, h) {
                        var d;
                ...
                var e, p = this.options, r, b = g, l, n = {}, d = [];
                e = p.formatter || this.defaultFormatter;
                var n = this.shared, w, q = this.chart.styledMode;
                p.enabled &&
                (a.clearTimeout(this.hideTimer), this.followPointer = u(b)[0].series.tooltipOptions.followPointer, l = this.getAnchor(b, f), f = l[0], r = l[1], !n || b.series && b.series.noSharedTooltip ? n = b.getLabelConfig() : (b.forEach(function (a) {
                    ...
                    x: b[0].category,
                    y: b[0].y
                }, n.points = d, b = b[0]), this.len = d.length, n = e.call(n, this), w = b.series, this.distance = t(w.tooltipOptions.distance, 16), !1 === n ? this.hide() : (e = this.getLabel(), this.isHidden && e.attr({opacity: 1}).show(), this.split ? this.renderSplit(n,
                    u(g)) : (p.style.width && !q || e.css({width: this.chart.spacingBox.width}), e.attr({text: n && n.join ? n.join("") : n}), e.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + t(b.colorIndex, w.colorIndex)), q || e.attr({stroke: p.borderColor || b.color || w.color || "#666666"}), this.updatePosition({
                    plotX: f,
                    plotY: r,
                    negative: b.negative,
                    ttBelow: b.ttBelow,
                ...
                var e = this, p = [], r = this.chart, b = r.renderer, l = !0, n = this.options, d = 0, w,
                    q = this.getLabel(), C = r.plotTop;
                a.isString(g) && (g = [!1, g]);
                g.slice(0, f.length + 1).forEach(function (a, c) {
                    if (!1 !== a && "" !== a) {
                        c = f[c - 1] || {isHeader: !0, plotX: f[0].plotX, plotY: r.plotHeight};
                        var k = c.series || e, x = k.tt, g = c.series || {},
                ...
                var r = this.chart.time, b = r.dateFormat("%m-%d %H:%M:%S.%L", f), l, n,
                    d = {millisecond: 15, second: 12, minute: 9, hour: 6, day: 3}, w = "millisecond";
                for (n in y) {
                ...
                var e = f ? "footer" : "header", p = g.series, r = p.tooltipOptions, b = r.xDateFormat, l = p.xAxis,
                    n = l && "datetime" === l.options.type && m(g.key), d = r[e + "Format"];
    ...
    (function (a) {
        var B = a.addEvent, A = a.attr, G = a.charts, m = a.color, g = a.css, t = a.defined, u = a.extend, v = a.find,
            y = a.fireEvent, q = a.isNumber, f = a.isObject, e = a.offset, p = a.pick, r = a.splat, b = a.Tooltip;
        ...
        a.Pointer.prototype = {
            init: function (a, n) {
                ...
                a.forEach(function (a) {
                    ...
                    a = a.searchPoint(d, n);
                    if ((n = f(a, !0)) && !(n = !f(l, !0))) var n = l.distX - a.distX, e = l.dist - a.dist,
                ...
                var d = a.series, l = d.xAxis, d = d.yAxis, n = p(a.clientX, a.plotX), e = a.shapeArgs;
                if (l && d) return b ? {
                ...
                return {hoverPoint: l, hoverSeries: b, hoverPoints: c}
                                          ...
                                          e) {
                var d = this.chart, l = d.tooltip && d.tooltip.options.enabled ? d.tooltip : void 0,
                    n = l ? l.shared : !1, f = e || d.hoverPoint, r = f && f.series || d.hoverSeries,
                ...
                var d = this.chart, l = d.hoverSeries, e = d.hoverPoint, n = d.hoverPoints, f = d.tooltip,
                    c = f && f.shared ? n : e;
                ...
                var b = this.chart, d = b.options.chart, l = a.chartX, e = a.chartY, f = this.zoomHor,
                    r = this.zoomVert, c = b.plotLeft, k = b.plotTop, x = b.plotWidth, g = b.plotHeight, h,
                    p = this.selectionMarker,
                    q = this.mouseDownX, t = this.mouseDownY, v = d.panKey && a[d.panKey + "Key"];
                p && p.touch || (l < c ? l = c : l > c + x && (l = c + x), e < k ? e = k : e > k + g && (e = k + g), this.hasDragged = Math.sqrt(Math.pow(q - l, 2) + Math.pow(t - e, 2)), 10 < this.hasDragged && (h = b.isInsidePlot(q - c, t - k), b.hasCartesianSeries && (this.zoomX || this.zoomY) && h && !v && !p && (this.selectionMarker = p = b.renderer.rect(c, k, f ? 1 : x, r ? 1 : g, 0).attr({
                    ...
                    zIndex: 7
                }).add(), b.styledMode || p.attr({fill: d.selectionMarkerFill || m("#335cad").setOpacity(.25).get()})), p &&
                f && (l -= q, p.attr({
                    width: Math.abs(l),
                    x: (0 < l ? 0 : l) + q
                })), p && r && (l = e - t, p.attr({
                ...
                if (this.selectionMarker) {
                    var e = {originalEvent: a, xAxis: [], yAxis: []}, f = this.selectionMarker,
                        r = f.attr ? f.attr("x") : f.x, c = f.attr ? f.attr("y") : f.y,
                        k = f.attr ? f.attr("width") : f.width, x = f.attr ? f.attr("height") : f.height, p;
                    if (this.hasDragged || l) d.axes.forEach(function (h) {
                        if (h.zoomEnabled && t(h.min) && (l || b[{
                            xAxis: "zoomX",
                            yAxis: "zoomY"
                        }[h.coll]])) {
                            var d = h.horiz, n = "touchend" === a.type ? h.minPixelPadding : 0,
                                f = h.toValue((d ? r : c) + n), d = h.toValue((d ? r + k : c + x) - n);
                ...
                d && q(d.index) && (g(d.container, {cursor: d._cursor}), d.cancelClick = 10 < this.hasDragged, d.mouseIsDown = this.hasDragged = this.hasPinched = !1, this.pinchDown =
                    [])
                ...
                var b = this.chart, d = b.hoverPoint, l = b.plotLeft, e = b.plotTop;
                a = this.normalize(a);
                b.cancelClick ||
                (d && this.inClass(a.target, "highcharts-tracker") ? (y(d.series, "click", u(a, {point: d})), b.hoverPoint && d.firePointEvent("click", a)) : (u(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - l, a.chartY - e) && y(b, "click", a)))
    ...
    (function (a) {
        var B = a.charts, A = a.extend, G = a.noop, m = a.pick;
        A(a.Pointer.prototype, {
            pinchTranslate: function (a, m, u, v, y, q) {
                ...
                var p = this.chart, r = a ? "x" : "y", b = a ? "X" : "Y", l = "chart" + b, n = a ? "width" : "height",
                    d = p["plot" +
                    (a ? "Left" : "Top")], w, g, C = e || 1, F = p.inverted, c = p.bounds[a ? "h" : "v"],
                    k = 1 === m.length, x = m[0][l], D = u[0][l], h = !k && m[1][l], z = !k && u[1][l], t;
                u = function () {
                ...
                var g =
                        this, u = g.chart, v = g.pinchDown, y = a.touches, q = y.length, f = g.lastValidTouch,
                    e = g.hasZoom, p = g.selectionMarker, r = {},
                ...
                "touchstart" === a.type ? ([].forEach.call(y, function (a, b) {
                    ...
                    if (a.zoomEnabled) {
                        var b =
                            ...
                            e = a.toPixels(m(a.options.min, a.dataMin)), f = a.toPixels(m(a.options.max, a.dataMax)),
                            n = Math.max(e, f);
    ...
    (function (a) {
        var B = a.addEvent, A = a.charts, G = a.css, m = a.doc, g = a.extend, t = a.noop, u = a.Pointer,
            v = a.removeEvent, y = a.win, q = a.wrap;
        if (!a.hasTouch && (y.PointerEvent || y.MSPointerEvent)) {
            var f = {}, e = !!y.PointerEvent, p = function () {
                var b = [];
                b.item = function (a) {
                    return this[a]
                };
            ...
            q(u.prototype, "init", function (a, l, e) {
                a.call(this, l, e);
                this.hasZoom &&
                G(l.container, {"-ms-touch-action": "none", "touch-action": "none"})
            });
    ...
    (function (a) {
        var B = a.addEvent, A = a.css, G = a.discardElement, m = a.defined, g = a.fireEvent, t = a.isFirefox,
            u = a.marginNames, v = a.merge, y = a.pick, q = a.setAnimation, f = a.stableSort, e = a.win, p = a.wrap;
        ...
        a.Legend.prototype =
            {
                init: function (a, b) {
                    ...
                    if (!this.chart.styledMode) {
                        var e = this.options, f = a.legendItem, d = a.legendLine,
                            r = a.legendSymbol, p = this.itemHiddenStyle.color, e = b ? e.itemStyle.color : p,
                            q = b ? a.color || p : p, m = a.options && a.options.marker, c = {fill: q};
                    ...
                    var b = this.options, e = b.symbolPadding, b = !b.rtl, f = a._legendItemPos,
                        d = f[0], f = f[1], r = a.checkbox;
                    ...
                    var a = this.group && this.group.alignAttr, b, e = this.clipHeight || this.legendHeight,
                        f = this.titleHeight;
                    ...
                    var a = this.options, b = this.padding, e = a.title, f = 0;
                    e.text && (this.title || (this.title = this.chart.renderer.label(e.text,
                        b - 3, b - 4, null, null, null, a.useHTML, null, "legend-title").attr({zIndex: 1}), this.chart.styledMode || this.title.css(e.style), this.title.add(this.group)), e.width || this.title.css({width: this.maxLegendWidth + "px"}), a = this.title.getBBox(), f = a.height, this.offsetWidth = a.width, this.contentGroup.attr({translateY: f}));
                    this.titleHeight = f
                }, setText: function (e) {
                    var b = this.options;
                    ...
                    var b = this.chart,
                        ...
                        r = this.itemHiddenStyle, q = "horizontal" === f.layout ? y(f.itemDistance, 20) : 0, c = !f.rtl,
                        k = a.legendItem, x = !a.series, D = !x && a.series.drawLegendSymbol ? a.series : a,
                        h = D.options, h = this.createCheckboxForItem && h && h.showCheckbox,
                        q = d + p + q + (h ? 20 : 0), z = f.useHTML, m = a.options.className;
                    k || (a.legendGroup = e.g("legend-item").addClass("highcharts-" + D.type + "-series highcharts-color-" + a.colorIndex + (m ? " " + m : "") + (x ? " highcharts-series-" + a.index : "")).attr({zIndex: 1}).add(this.scrollGroup),
                    ...
                    var b = this.options, e = this.padding, f = "horizontal" === b.layout, d = a.itemHeight,
                        p = b.itemMarginBottom || 0, g = this.itemMarginTop,
                        r = f ? y(b.itemDistance, 20) : 0, q = this.maxLegendWidth,
                    ...
                    var e = this.chart, f = this.options, d = this.getAlignment(),
                    ...
                    var e = this.chart, b = e.renderer, l = this.group, n, d, p, q = this.box, m = this.options,
                        F = this.padding;
                    this.itemX = F;
                    ...
                    l || (this.group = l = b.g("legend").attr({zIndex: 7}).add(), this.contentGroup = b.g().attr({zIndex: 1}).add(l), this.scrollGroup = b.g().add(this.contentGroup));
                    this.renderTitle();
                    n = this.getAllItems();
                    f(n, function (a, b) {
                    ...
                    p += F;
                    q || (this.box = q = b.rect().addClass("highcharts-legend-box").attr({r: m.borderRadius}).add(l), q.isNew = !0);
                    e.styledMode || q.attr({
                    ...
                    this.legendWidth = n;
                    this.legendHeight = p;
                    d && (b = e.spacingBox, /(lth|ct|rth)/.test(this.getAlignment()) && (q = b.y + e.titleOffset, b = v(b, {y: 0 < e.titleOffset ? q += e.options.title.margin : q})), l.align(v(m, {
                        width: n,
                        height: p,
                ...
                handleOverflow: function (a) {
                    var b = this, e = this.chart, f = e.renderer, d = this.options, p = d.y, g = this.padding,
                        p = e.spacingBox.height + ("top" === d.verticalAlign ? -p : p) - g, r = d.maxHeight, q,
                        c = this.clipRect, k = d.navigation, x = y(k.animation, !0), D = k.arrowSize || 12,
                        h = this.nav, z = this.pages, m, t = this.allItems, v = function (a) {
                    ...
                    a > p && !1 !== k.enabled ? (this.clipHeight = q = Math.max(p - 20 - this.titleHeight - g, 0), this.currentPage = y(this.currentPage, 1), this.fullHeight = a, t.forEach(function (a, c) {
                        var b = a._legendItemPos[1], k = Math.round(a.legendItem.getBBox().height), h = z.length;
                        ...
                        g, 9999, 0), b.contentGroup.clip(c)), v(q), h || (this.nav = h = f.g().attr({zIndex: 1}).add(this.group), this.up = f.symbol("triangle", 0, 0, D, D).on("click", function () {
                        b.scroll(-1, x)
                        ...
                        b.scroll(1, x)
                    }).add(h)), b.scroll(0), a = p) : h && (v(), this.nav = h.destroy(), this.scrollGroup.attr({translateY: 1}), this.clipHeight = 0);
                    return a
                },
                scroll: function (a, b) {
                    var e = this.pages, f = e.length;
                    a = this.currentPage + a;
                    var d = this.clipHeight, p = this.options.navigation, g = this.pager, r = this.padding;
                    a > f && (a = f);
                    0 < a && (void 0 !== b && q(b, this.chart), this.nav.attr({
                        translateX: r,
                        translateY: d + this.padding + 7 + this.titleHeight,
                        visibility: "visible"
                    }), this.up.attr({"class": 1 === a ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active"}), g.attr({text: a + "/" + f}), this.down.attr({
                        x: 18 + this.pager.getBBox().width,
                        "class": a === f ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active"
                    }),
                    this.chart.styledMode || (this.up.attr({fill: 1 === a ? p.inactiveColor : p.activeColor}).css({cursor: 1 === a ? "default" : "pointer"}), this.down.attr({fill: a === f ? p.inactiveColor : p.activeColor}).css({cursor: a === f ? "default" : "pointer"})), this.scrollOffset = -e[a - 1] + this.initialItemY, this.scrollGroup.animate({translateY: this.scrollOffset}), this.currentPage = a, this.positionCheckboxes())
                }
            };
        a.LegendSymbolMixin = {
            drawRectangle: function (a, b) {
                var e = a.symbolHeight, f = a.options.squareSymbol;
                b.legendSymbol = this.chart.renderer.rect(f ?
                    (a.symbolWidth - e) / 2 : 0, a.baseline - e + 1, f ? e : a.symbolWidth, e, y(a.options.symbolRadius, e / 2)).addClass("highcharts-point").attr({zIndex: 3}).add(b.legendGroup)
            }, drawLineMarker: function (a) {
                var b = this.options, e = b.marker, f = a.symbolWidth, d = a.symbolHeight, p = d / 2,
                    g = this.chart.renderer, r = this.legendGroup;
                a = a.baseline - Math.round(.3 * a.fontMetrics.b);
                var q = {};
                this.chart.styledMode || (q = {"stroke-width": b.lineWidth || 0}, b.dashStyle && (q.dashstyle = b.dashStyle));
    ...
    (function (a) {
        var B = a.addEvent, A = a.animate, G = a.animObject, m = a.attr,
            g = a.doc, t = a.Axis, u = a.createElement, v = a.defaultOptions, y = a.discardElement, q = a.charts,
            f = a.css, e = a.defined, p = a.extend, r = a.find, b = a.fireEvent, l = a.isNumber, n = a.isObject,
            d = a.isString, w = a.Legend, E = a.marginNames, C = a.merge, F = a.objectEach, c = a.Pointer, k = a.pick,
            x = a.pInt, D = a.removeEvent, h = a.seriesTypes, z = a.splat, L = a.syncTimeout, J = a.win,
            W = a.Chart = function () {
        ...
        p(W.prototype, {
            callbacks: [], getArgs: function () {
                ...
                var h, d, e = c.series, x = c.plotOptions || {};
                ...
                b(this, "beforeRedraw");
                var k = this.axes, h = this.series, d = this.pointer, e = this.legend, x = this.userOptions.legend,
                    f = this.isDirtyLegend, l, n, g = this.hasCartesianSeries, z = this.isDirtyBox, r,
                    D = this.renderer, q = D.isHidden(), w = [];
                this.setResponsive &&
                ...
                var b, k = this.series, h;
                b = r(this.axes, c) || r(this.series, c);
                for (h = 0; !b && h < k.length; h++) b = r(k[h].points || [], c);
                return b
            }, getAxes: function () {
                var a = this, c = this.options, k = c.xAxis = z(c.xAxis || {}), c = c.yAxis = z(c.yAxis || {});
                b(this, "getAxes");
                ...
                var k = this, h = k.options, d = k.styledMode, e;
                ...
                var c = 0, b, h = this.renderer, d = this.spacingBox;
                ["title", "subtitle"].forEach(function (a) {
                    var b = this[a], k = this.options[a];
                    a = "title" === a ? -3 : k.verticalAlign ? 0 : c + 2;
                    var e;
                    b && (this.styledMode || (e = k.style.fontSize), e = h.fontMetrics(e,
                        b).b, b.css({width: (k.width || d.width + k.widthAdjust) + "px"}).align(p({y: a + e}, k), !1, "spacingBox"), k.floating || k.verticalAlign || (c = Math.ceil(c + b.getBBox(k.useHTML).height)))
                }, this);
                ...
                var c = this.options.chart, b = c.width, c = c.height, k = this.renderTo;
                ...
                var b = this.renderTo;
                if (c) for (; b && b.style;) b.hcOrigStyle && (a.css(b, b.hcOrigStyle), delete b.hcOrigStyle), b.hcOrigDetached && (g.body.removeChild(b), b.hcOrigDetached = !1), b = b.parentNode; else for (; b && b.style;) {
                ...
                var c, k = this.options, h = k.chart, e, n;
                c = this.renderTo;
                var r = a.uniqueKey(),
                    z, D;
                ...
                if (this.styledMode) for (D in k.defs) this.renderer.definition(k.defs[D]); else this.renderer.setStyle(h.style);
                this.renderer.chartIndex = this.index;
                b(this, "afterGetContainer")
            }, getMargins: function (a) {
                var c = this.spacing, k = this.margin,
                    h = this.titleOffset;
                this.resetMargins();
                ...
                var a = this, c = a.axisOffset = [0, 0, 0, 0], b = a.margin;
                ...
                var b = this, k = b.options.chart, h = b.renderTo,
                    d = e(k.width) && e(k.height), x = k.width || a.getStyle(h, "width"),
                    k = k.height || a.getStyle(h, "height"), h = c ? c.target : J;
                ...
                var c = this.inverted, k = this.renderer, h = this.chartWidth, d = this.chartHeight,
                    e = this.options.chart, x = this.spacing, f = this.clipOffset, l, p, n, g;
                ...
                var a =
                        this.options.chart, c = this.renderer, k = this.chartWidth, h = this.chartHeight,
                    d = this.chartBackground, e = this.plotBackground, x = this.plotBorder, f, l = this.styledMode,
                    p = this.plotBGImage, n = a.backgroundColor, g = a.plotBackgroundColor, z = a.plotBackgroundImage,
                    r, D = this.plotLeft, q = this.plotTop, w = this.plotWidth, m = this.plotHeight, E = this.plotBox,
                    F = this.clipRect, C = this.clipBox, t = "animate";
                ...
                e[t](E);
                l || (e.attr({fill: g || "none"}).shadow(a.plotShadow), z && (p ? p.animate(E) : this.plotBGImage = c.image(z, D, q, w, m).add()));
                F ? F.animate({width: C.width, height: C.height}) : this.clipRect = c.clipRect(C);
                t = "animate";
                x || (t = "attr", this.plotBorder = x = c.rect().addClass("highcharts-plot-border").attr({zIndex: 1}).add());
                ...
                var a = this, c = a.options.chart, b, k = a.options.series, d, e;
                ...
                c.items && c.items.forEach(function (b) {
                    var k = p(c.style, b.style), h = x(k.left) + a.plotLeft, d = x(k.top) + a.plotTop + 12;
                    delete k.left;
                    delete k.top;
                    a.renderer.text(b.html, h, d).attr({zIndex: 2}).css(k).add()
                })
            }, render: function () {
                var a = this.axes, c = this.renderer, b = this.options, k = 0, h, d, e;
                this.setTitle();
            ...
            destroy: function () {
                var c = this, k = c.axes, h = c.series, d = c.container, e, x = d && d.parentNode;
                b(c, "destroy");
    ...
    (function (a) {
        ...
        A.prototype.applyFixed = function () {
            var A = this.container, m, g, t = !this.fixedDiv;
            t && (this.fixedDiv = a.createElement("div", {className: "highcharts-fixed"}, {
                ...
                zIndex: -1
            }).addClass("highcharts-scrollable-mask").add(), [this.inverted ? ".highcharts-xaxis" : ".highcharts-yaxis", this.inverted ? ".highcharts-xaxis-labels" : ".highcharts-yaxis-labels", ".highcharts-contextbutton", ".highcharts-legend", ".highcharts-subtitle", ".highcharts-title", ".highcharts-legend-checkbox"].forEach(function (a) {
            ...
            var t = this.plotTop + this.plotHeight + t[2], u = this.plotLeft + this.plotWidth - this.scrollablePixels;
            this.scrollableMask.attr({d: this.scrollablePixels ? ["M", 0, g, "L", this.plotLeft - 1, g, "L", this.plotLeft - 1, t, "L", 0, t, "Z", "M", u, g, "L", this.chartWidth, g, "L", this.chartWidth, t, "L", u, t, "Z"] : ["M", 0, 0]})
        }
    })(H);
    (function (a) {
        var B, A = a.extend, G = a.erase, m = a.fireEvent, g = a.format, t = a.isArray, u = a.isNumber, v = a.pick,
        ...
        a.Point.prototype = {
            init: function (a, f, g) {
                ...
                var f = {}, g = this.series, b = g.options.keys, l = b || g.pointArrayMap || ["y"], n = l.length, d = 0,
                    q = 0;
                if (u(e) || null === e) f[l[0]] = e; else if (t(e)) for (!b && e.length > n && (g = typeof e[0], "string" === g ? f.name = e[0] : "number" === g && (f.x = e[0]), d++); q < n;) b && void 0 === e[d] || (0 < l[q].indexOf(".") ? a.Point.prototype.setNestedProperty(f,
                    e[d], l[q]) : f[l[q]] = e[d]), d++, q++; else "object" === typeof e && (f = e, e.dataLabels && (g._hasPointLabels = !0), e.marker && (g._hasPointMarkers = !0));
                return f
            }, getClassName: function () {
                return "highcharts-point" + (this.selected ? " highcharts-point-select" : "") + (this.negative ? " highcharts-negative" : "") + (this.isNull ? " highcharts-null-point" : "") + (void 0 !== this.colorIndex ? " highcharts-color-" + this.colorIndex : "") + (this.options.className ? " " + this.options.className : "") + (this.zone && this.zone.className ? " " + this.zone.className.replace("highcharts-negative",
                    "") : "")
            }, getZone: function () {
                var a = this.series, f = a.zones, a = a.zoneAxis || "y", g = 0, b;
                for (b = f[g]; this[a] >= b.value;) b = f[++g];
                this.nonZonedColor || (this.nonZonedColor = this.color);
                this.color = b && b.color && !this.options.color ? b.color : this.nonZonedColor;
                return b
            }, destroy: function () {
                var a = this.series.chart, p = a.hoverPoints, g;
                a.pointCount--;
                ...
                var e = this.series, f = e.tooltipOptions, b = v(f.valueDecimals, ""), l = f.valuePrefix || "",
                    n = f.valueSuffix || "";
    ...
    (function (a) {
        var B = a.addEvent, A = a.animObject, G = a.arrayMax, m = a.arrayMin, g = a.correctFloat, t = a.defaultOptions,
            u = a.defaultPlotOptions, v = a.defined, y = a.erase, q = a.extend,
            f = a.fireEvent, e = a.isArray, p = a.isNumber, r = a.isString, b = a.merge, l = a.objectEach, n = a.pick,
            d = a.removeEvent, w = a.splat, E = a.SVGElement, C = a.syncTimeout, F = a.win;
        a.Series = a.seriesType("line", null, {
            ...
            },
            {
                ...
                insert: function (a) {
                    ...
                    if (p(c)) {
                        for (b = a.length; b--;) if (c >= n(a[b].options.index, a[b]._i)) {
                            a.splice(b + 1, 0, this);
                            break
                        }
                        -1 === b && a.unshift(this);
                ...
                bindAxes: function () {
                    var c = this, b = c.options, d = c.chart, e;
                ...
                updateParallelArrays: function (a, b) {
                    var c = a.series, k = arguments, h = p(b) ? function (k) {
                ...
                autoIncrement: function () {
                    var a = this.options, b = this.xIncrement, d, e = a.pointIntervalUnit, h = this.chart.time,
                ...
                setOptions: function (a) {
                    var c = this.chart,
                        d = c.options, e = d.plotOptions, h = (c.userOptions || {}).plotOptions || {}, l = e[this.type],
                        g = b(a);
                    a = c.styledMode;
                ...
                getCyclic: function (a, b, d) {
                    var c, k = this.chart, e = this.userOptions, f = a + "Index", x = a + "Counter",
                ...
                updateData: function (c) {
                    var b = this.options, d = this.points, e = [], h, f, l, g = this.requireSorting;
                    ...
                    if (h) for (c = d.length; c--;) f = d[c], f.touched || f.remove(!1), f.touched = !1; else if (c.length === d.length) c.forEach(function (a, c) {
                ...
                setData: function (c, b, d, f) {
                    var k = this, l =
                            k.points, x = l && l.length || 0, g, q = k.options, w = k.chart, D = null, m = k.xAxis,
                        E = q.turboThreshold, F = this.xData, C = this.yData, t = (g = k.pointArrayMap) && g.length,
                        v = q.keys, u = 0, y = 1, A;
                    c = c || [];
                    g = c.length;
                    b = n(b, !0);
                    ...
                    if (!A) {
                        ...
                        if (E && g > E) {
                            ...
                            else if (e(D)) if (t) for (d = 0; d < g; d++) D = c[d], F[d] = D[0], C[d] = D.slice(1, t + 1); else for (v && (u = v.indexOf("x"), y = v.indexOf("y"), u = 0 <= u ? u : 0, y = 0 <= y ? y : 1), d = 0; d < g; d++) D = c[d], F[d] = D[u], C[d] = D[y]; else a.error(12, !1, w)
                        } else for (d = 0; d < g; d++) void 0 !== c[d] && (D = {series: k}, k.pointClass.prototype.applyOptions.apply(D, [c[d]]), k.updateParallelArrays(D, d));
                ...
                processData: function (c) {
                    var b = this.xData, d = this.yData, e = b.length, h;
                    h = 0;
                    var f, l, g = this.xAxis, n, p = this.options;
                    n = p.cropThreshold;
                    var q = this.getExtremesFromAll || p.getExtremesFromAll, w = this.isCartesian, p = g && g.val2lin,
                        r = g && g.isLog, m = this.requireSorting, E, F;
                ...
                cropData: function (a, b, d, e, h) {
                    var c = a.length, k = 0, f = c, l;
                    h = n(h, this.cropShoulder);
                    for (l = 0; l < c; l++) if (a[l] >= d) {
                        k = Math.max(0, l - h);
                        break
                    }
                    for (d =
                ...
                generatePoints: function () {
                    var a = this.options, b = a.data, d = this.data, e, h = this.processedXData,
                        l = this.processedYData, g = this.pointClass, n = h.length, p = this.cropStart || 0, r,
                        m = this.hasGroupedData, a = a.keys, E, F = [], C;
                    ...
                    this.options.keys = a;
                    if (d && (n !== (e = d.length) || m)) for (C = 0; C < e; C++) C !== p || m || (C += n), d[C] && (d[C].destroyElements(), d[C].plotX = void 0);
                    this.data = d;
                    this.points = F;
                    f(this, "afterGeneratePoints")
                },
                getExtremes: function (a) {
                    var c = this.yAxis, b = this.processedXData, d, h = [], l = 0;
                    d = this.xAxis.getExtremes();
                    var g = d.min, n = d.max, q, w, r = this.requireSorting ? this.cropShoulder :
                        0, E, F;
                    a = a || this.stackedYData || this.processedYData || [];
                    d = a.length;
                    for (F = 0; F < d; F++) if (w = b[F], E = a[F], q = (p(E, !0) || e(E)) && (!c.positiveValuesOnly || E.length || 0 < E), w = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (b[F + r] || w) >= g && (b[F - r] || w) <= n, q && w) if (q = E.length) for (; q--;) "number" === typeof E[q] && (h[l++] = E[q]); else h[l++] = E;
                    this.dataMin = m(h);
                    this.dataMax = G(h);
                ...
                translate: function () {
                    ...
                    this.generatePoints();
                    var a = this.options,
                        b = a.stacking, d = this.xAxis, e = d.categories, h = this.yAxis, l = this.points, q = l.length,
                        w = !!this.modifyValue, r, m = this.pointPlacementToXValue(), E = p(m), F = a.threshold,
                        C = a.startFromThreshold ? F : 0, t, u, y, A, B = this.zoneAxis || "y", G = Number.MAX_VALUE;
                    for (r = 0; r < q; r++) {
                        var M = l[r], V = M.x, N = M.y;
                        u = M.low;
                        var H = b && h.stacks[(this.negStacks && N < (C ? 0 : F) ? "-" : "") + this.stackKey], X;
                ...
                setClip: function (a) {
                    var c = this.chart, b = this.options, d = c.renderer, h = c.inverted, e = this.clipBox,
                        f = e || c.clipBox,
                        l = this.sharedClipKey || ["_sharedClip", a && a.duration, a && a.easing, f.height, b.xAxis, b.yAxis].join(),
                        g = c[l], n = c[l + "m"];
                    g || (a && (f.width = 0, h && (f.x = c.plotSizeX), c[l + "m"] = n = d.clipRect(h ? c.plotSizeX + 99 : -99, h ? -c.plotLeft : -c.plotTop, 99, h ? c.chartWidth : c.chartHeight)), c[l] = g = d.clipRect(f), g.count = {length: 0});
                ...
                animate: function (a) {
                    var c = this.chart, b = A(this.options.animation), d;
                    a ? this.setClip(b) : (d = this.sharedClipKey, (a = c[d]) && a.animate({
                        width: c.plotSizeX,
                        x: 0
                    }, b), c[d + "m"] && c[d + "m"].animate({width: c.plotSizeX + 99, x: 0}, b), this.animate = null)
                },
                ...
                drawPoints: function () {
                    var a = this.points, b = this.chart, d, e, h, f, l = this.options.marker, g, p, q,
                    ...
                    if (!1 !== l.enabled || this._hasPointMarkers) for (d = 0; d < a.length; d++) e = a[d], f = e.graphic, g = e.marker || {}, p = !!e.marker, h = m && void 0 === g.enabled || g.enabled, q = !1 !== e.isInside, h && !e.isNull ? (h = n(g.symbol, this.symbol), r = this.markerAttribs(e,
                ...
                markerAttribs: function (a, b) {
                    var c = this.options.marker, k = a.marker || {}, h = k.symbol || c.symbol,
                ...
                pointAttribs: function (a, b) {
                    var c = this.options.marker, k = a && a.options, h = k && k.marker || {}, d = this.color,
                        e = k && k.color, f = a && a.color, k = n(h.lineWidth, c.lineWidth);
                ...
                destroy: function (c) {
                    var b = this, e = b.chart, g = /AppleWebKit\/533/.test(F.navigator.userAgent), h, n,
                        p = b.data || [], q, w;
                    f(b, "destroy");
                    c || d(b);
                ...
                getGraphPath: function (a, b, d) {
                    var c = this, k = c.options, e = k.step, f, l = [], g = [], n;
                    a = a || c.points;
                    (f = a.reversed) && a.reverse();
                    (e = {right: 1, center: 2}[e] || e && 3) && f && (e = 4 - e);
                    !k.connectNulls || b || d || (a = this.getValidPoints(a));
                    a.forEach(function (h, f) {
                        var x = h.plotX, p = h.plotY, q = a[f - 1];
                        (h.leftCliff || q && q.rightCliff) && !d && (n = !0);
                        h.isNull && !v(b) && 0 < f ? n =
                            !k.connectNulls : h.isNull && !b ? n = !0 : (0 === f || n ? f = ["M", h.plotX, h.plotY] : c.getPointSpline ? f = c.getPointSpline(a, h, f) : e ? (f = 1 === e ? ["L", q.plotX, p] : 2 === e ? ["L", (q.plotX + x) / 2, q.plotY, "L", (q.plotX + x) / 2, p] : ["L", x, q.plotY], f.push("L", x, p)) : f = ["L", x, p], g.push(h.x), e && (g.push(h.x), 2 === e && g.push(h.x)), l.push.apply(l, f), n = !1)
                    });
                    l.xMap = g;
                ...
                drawGraph: function () {
                    var a = this, b = this.options, d = (this.gappedPath || this.getGraphPath).call(this),
                        e = this.chart.styledMode, h = [["graph", "highcharts-graph"]];
                    e || h[0].push(b.lineColor ||
                        this.color, b.dashStyle);
                    h = a.getZonesGraphs(h);
                    h.forEach(function (c, k) {
                        var h = c[0], f = a[h];
                        f ? (f.endX = a.preventGraphAnimation ? null : d.xMap, f.animate({d: d})) : d.length && (a[h] = a.chart.renderer.path(d).addClass(c[1]).attr({zIndex: 1}).add(a.group), e || (f = {
                            stroke: c[2],
                ...
                applyZones: function () {
                    var a = this, b = this.chart, d = b.renderer, e = this.zones, h, f, l = this.clips || [], g,
                        p = this.graph, q = this.area, w = Math.max(b.chartWidth, b.chartHeight),
                        r = this[(this.zoneAxis || "y") + "Axis"], m, E, F = b.inverted, C, t, v, u, y = !1;
                    ...
                    p.hide(), q && q.hide(), m = r.getExtremes(), e.forEach(function (c, k) {
                        ...
                        F && d.isVML && (g = r.isXAxis ? {x: 0, y: E ? v : u, height: g.width, width: b.chartWidth} : {
                            x: g.y - b.plotLeft -
                                b.spacingBox.x, y: 0, width: g.height, height: b.chartHeight
                        });
                ...
                render: function () {
                    var a = this, b = a.chart, d, e = a.options,
                        ...
                        l = a.visible ? "inherit" : "hidden", g = e.zIndex, n = a.hasRendered, p = b.seriesGroup,
                        q = b.inverted;
                    f(this, "render");
                ...
                searchPoint: function (a, b) {
                    var c = this.xAxis, k = this.yAxis, h = this.chart.inverted;
                ...
                searchKDTree: function (a, b, d) {
                    function c(a, b, d, h) {
                        var g = b.point, n = k.kdAxisArray[d % h], p, x, q = g;
                    ...
                    var k = this, e = this.kdAxisArray[0], f = this.kdAxisArray[1], l = b ? "distX" : "dist";
    ...
    (function (a) {
        var B = a.Axis, A = a.Chart, G = a.correctFloat, m = a.defined, g = a.destroyObjectProperties, t = a.format,
            u = a.objectEach, v = a.pick, y = a.Series;
        ...
        a.StackItem.prototype = {
            destroy: function () {
                ...
                var f = this.axis.chart, e = this.options, g = e.format,
                ...
                var e = this.axis, g = e.chart, q = e.translate(e.usePercentage ? 100 : this.total, 0, 0, 0, 1),
                    b = e.translate(0), b = m(q) && Math.abs(q - b);
        ...
        B.prototype.renderStackTotals = function () {
            var a = this.chart, f = a.renderer, e = this.stacks, g = this.stackTotalGroup;
        ...
        y.prototype.setStackedPoints = function () {
            if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                var g = this.processedXData, f = this.processedYData, e = [], p = f.length, r = this.options,
                    b = r.threshold, l = v(r.startFromThreshold &&
                    b, 0), n = r.stack, r = r.stacking, d = this.stackKey, w = "-" + d, E = this.negStacks,
                    C = this.yAxis, F = C.stacks, c = C.oldStacks, k, x, D, h, z, t, u;
                C.stacksTouched += 1;
        ...
        y.prototype.modifyStacks = function () {
            var a =
                this, f = a.stackKey, e = a.yAxis.stacks, g = a.processedXData, r, b = a.options.stacking;
            a[b + "Stacker"] && [f, "-" + f].forEach(function (f) {
                for (var l = g.length, d, p; l--;) if (d = g[l], r = a.getStackIndicator(r, d, a.index, f), p = (d = e[f] && e[f][d]) && d.points[r.key]) a[b + "Stacker"](p, d, l)
            })
        };
    ...
    (function (a) {
        var B = a.addEvent, A = a.animate, G = a.Axis, m = a.Chart, g = a.createElement, t = a.css, u = a.defined,
            v = a.erase, y = a.extend, q = a.fireEvent, f = a.isNumber, e = a.isObject, p = a.isArray, r = a.merge,
            b = a.objectEach, l = a.pick, n = a.Point, d = a.Series, w = a.seriesTypes, E = a.setAnimation, C = a.splat;
        ...
        y(m.prototype,
            {
                addSeries: function (a, c, b) {
                    var k, d = this;
                    a && (c = l(c, !0), q(d, "addSeries", {options: a}, function () {
                        k = d.initSeries(a);
                        d.isDirtyLegend = !0;
                        d.linkSeries();
                        q(d, "afterAddSeries");
                ...
                addAxis: function (a, c, b, d) {
                    var k = c ? "xAxis" : "yAxis", h = this.options;
                ...
                showLoading: function (a) {
                    var c = this, b = c.options, d = c.loadingDiv, e = b.loading, h = function () {
                        d && t(d, {
                            left: c.plotLeft + "px", top: c.plotTop +
                                "px", width: c.plotWidth + "px", height: c.plotHeight + "px"
                        })
                    };
                    d || (c.loadingDiv = d = g("div", {className: "highcharts-loading highcharts-loading-hidden"}, null, c.container), c.loadingSpan = g("span", {className: "highcharts-loading-inner"}, null, d), B(c, "redraw", h));
                    d.className = "highcharts-loading";
                    c.loadingSpan.innerHTML = a || b.lang.loading;
                    c.styledMode || (t(d, y(e.style, {zIndex: 10})), t(c.loadingSpan, e.labelStyle), c.loadingShown || (t(d, {
                        opacity: 0,
                        display: ""
                ...
                hideLoading: function () {
                    ...
                    c && (c.className = "highcharts-loading highcharts-loading-hidden", this.styledMode || A(c, {opacity: 0}, {
                ...
                update: function (d, c, k, e) {
                    var g = this, h = {title: "setTitle", subtitle: "setSubtitle"}, n, p, x,
                        w = [];
                    ...
                    b(d, function (a, c) {
                        if (g[c] && "function" === typeof g[c].update) g[c].update(a,
                            !1); else if ("function" === typeof g[h[c]]) g[h[c]](a);
                    ...
                    this.collectionsWithUpdate.forEach(function (a) {
                        ...
                        d[a] && ("series" === a && (c = [], g[a].forEach(function (a, b) {
                            ...
                            if (!d && k) if ("series" === a) g.addSeries(b, !1).touched = !0; else if ("xAxis" === a || "yAxis" === a) g.addAxis(b, "xAxis" ===
                                a, !1).touched = !0
        ...
        y(n.prototype,
            {
                update: function (a, c, b, d) {
                    ...
                    var h = this, f = h.series, g = h.graphic, n, p = f.chart, x = f.options;
                    c = l(c, !0);
        ...
        y(d.prototype, {
            addPoint: function (a, c, b, d) {
                var k = this.options, h = this.data, e = this.chart, f = this.xAxis, f = f && f.hasNames && f.names,
                    g = k.data, n, p, x = this.xData, w, r;
                c = l(c, !0);
                n = {series: this};
                ...
                var d = this, k = d.data, h = k[a], e = d.points, f = d.chart, g = function () {
                    e && e.length === k.length &&
                    e.splice(a, 1);
                    k.splice(a, 1);
                ...
                var d = this, e = d.chart, f = d.userOptions,
                    h = d.initialType || d.type, g = b.type || f.type || e.options.chart.type, n = w[h].prototype, p,
                    m = ["group", "markerGroup", "dataLabelsGroup"], E = ["navigatorSeries", "baseSeries"],
                    C = d.finishedAnimating && {animation: !1}, t = ["data", "name", "turboThreshold"],
                ...
                if (F) b.data && this.setData(b.data, !1), b.name && this.setName(b.name, !1); else {
                    ...
                    b = r(f, C, {index: d.index, pointStart: l(f.pointStart, d.xData[0])},
                        {data: d.options.data}, b);
                    d.remove(!1, null, !1, !0);
    ...
    (function (a) {
        var B = a.color, A = a.pick, G = a.Series, m = a.seriesType;
        m("area", "line", {softThreshold: !1, threshold: 0}, {
            singleStacks: !1, getStackPoints: function (g) {
                var m = [], u = [], v = this.xAxis, y = this.yAxis, q = y.stacks[this.stackKey], f = {}, e = this.index,
                ...
                if (this.options.stacking) {
                    ...
                    u.forEach(function (a, g) {
                        ...
                        if (f[a] && !f[a].isNull) m.push(f[a]), [-1, 1].forEach(function (c) {
                            var d = 1 === c ? "rightNull" : "leftNull", x = 0, m = q[u[g + c]];
                            if (m) for (n = e; 0 <= n && n < r;) p = m.points[n], p || (n === e ? f[a][d] = !0 : b[n] && (w = q[a].points[n]) && (x -= w[1] - w[0])),
                                n += l;
                ...
                var g = G.prototype.getGraphPath, m = this.options, v = m.stacking, y = this.yAxis, q, f, e = [],
                    p = [], r = this.index, b, l = y.stacks[this.stackKey], n = m.threshold,
                    d = y.getThreshold(m.threshold), w, m = m.connectNulls || "percent" === v, E = function (f, g, c) {
                        var k = a[f];
                        f = v && l[k.x].points[r];
                        var x =
                            k[c + "Null"] || 0;
                ...
                for (q = 0; q < a.length; q++) if (f = a[q].isNull, b = A(a[q].rectPlotX, a[q].plotX), w = A(a[q].yBottom, d), !f || m) m || E(q, q - 1, "left"), f && !v && m || (p.push(a[q]), e.push({
                    x: q,
                    plotX: b,
                    plotY: w
                })), m || E(q, q + 1, "right");
                ...
                var a = this, m = this.areaPath, u = this.options,
                ...
                v.forEach(function (g) {
                    var q =
                        g[0], f = a[q];
                    f ? (f.endX = a.preventGraphAnimation ? null : m.xMap, f.animate({d: m})) : (f = {zIndex: 0}, a.chart.styledMode || (f.fill = A(g[3], B(g[2]).setOpacity(A(u.fillOpacity, .75)).get())), f = a[q] = a.chart.renderer.path(m).addClass(g[1]).attr(f).add(a.group), f.isArea = !0);
                    f.startX = m.xMap;
    ...
    (function (a) {
        ...
        a("spline", "line", {}, {
            getPointSpline: function (a, G, m) {
                var g = G.plotX, t = G.plotY, u = a[m - 1];
                m = a[m + 1];
                var v, y, q,
                    f;
    ...
    (function (a) {
        var B = a.animObject, A = a.color, G = a.extend, m = a.defined, g = a.isNumber, t = a.merge, u = a.pick,
            v = a.Series, y = a.seriesType, q = a.svg;
        y("column", "line", {
            borderRadius: 0,
            crisp: !0,
            groupPadding: .2,
            ...
            getColumnMetrics: function () {
                var a = this, e = a.options, g = a.xAxis, r = a.yAxis, b = g.options.reversedStacks,
                    b = g.reversed && !b || !g.reversed && b, l, n = {}, d = 0;
                !1 === e.grouping ? d = 1 : a.chart.series.forEach(function (b) {
                    var c = b.options, k = b.yAxis, e;
                ...
                var w = Math.min(Math.abs(g.transA) * (g.ordinalSlope || e.pointRange ||
                    g.closestPointRange || g.tickInterval || 1), g.len), q = w * e.groupPadding,
                    m = (w - 2 * q) / (d || 1),
            ...
            crispCol: function (a, e, g, r) {
                var b = this.chart, f = this.borderWidth, n = -(f % 2 ? .5 : 0), f = f % 2 ? .5 : 1;
            ...
            translate: function () {
                var a = this, e = a.chart, g = a.options, r = a.dense = 2 > a.closestPointRange * a.xAxis.transA,
                    r = a.borderWidth = u(g.borderWidth, r ? 0 : 1), b = a.yAxis, l = g.threshold,
                    n = a.translatedThreshold = b.getThreshold(l), d = u(g.minPointLength, 5), w = a.getColumnMetrics(),
                    q = w.width, C = a.barW = Math.max(q, 1 + 2 * r), t = a.pointXOffset = w.offset;
                e.inverted && (n -= .5);
                g.pointPadding && (C = Math.ceil(C));
                v.prototype.translate.apply(a);
                a.points.forEach(function (c) {
                    var k =
                            u(c.yBottom, n), f = 999 + Math.abs(k), g = q, f = Math.min(Math.max(-f, c.plotY), b.len + f),
                        h = c.plotX + t, p = C, w = Math.min(f, k), r, E = Math.max(f, k) - w;
            ...
            pointAttribs: function (a, e) {
                ...
                var l = b["stroke-width"] || "borderWidth", n = a && a.color || this.color,
                    d = a && a[g] || f[g] || this.color || n, w = a && a[l] || f[l] || this[l] || 0, b = f.dashStyle;
            ...
            drawPoints: function () {
                var a = this, e = this.chart, p = a.options, r = e.renderer, b = p.animationLimit || 250, l;
                a.points.forEach(function (f) {
                    var d = f.graphic, n = d && e.pointCount < b ? "animate" : "attr";
            ...
            animate: function (a) {
                var e = this, f = this.yAxis, g = e.options, b = this.chart.inverted, l = {},
                    n = b ? "translateX" : "translateY", d;
                q && (a ? (l.scaleY = .001, a = Math.min(f.pos + f.len, Math.max(f.pos, f.toPixels(g.threshold))), b ? l.translateX =
                    a - f.len : l.translateY = a, e.clipBox && e.setClip(), e.group.attr(l)) : (d = e.group.attr(n), e.group.animate({scaleY: 1}, G(B(e.options.animation), {
                    step: function (a, b) {
                        l[n] = d + b.pos * (f.pos - d);
                        e.group.attr(l)
                    }
        ...
        A("scatter",
            "line", {
                ...
                applyJitter: function () {
                    var a = this, m = this.options.jitter, g = this.points.length;
                    m && this.points.forEach(function (t, u) {
                        ["x", "y"].forEach(function (v, y) {
                            var q, f = "plot" + v.toUpperCase(), e, p;
    ...
    (function (a) {
        var B =
            a.deg2rad, A = a.isNumber, G = a.pick, m = a.relativeLength;
        a.CenteredSeriesMixin = {
            getCenter: function () {
                var a = this.options, t = this.chart, u = 2 * (a.slicedOffset || 0), v = t.plotWidth - 2 * u,
                    t = t.plotHeight - 2 * u, y = a.center,
                    y = [G(y[0], "50%"), G(y[1], "50%"), a.size || "100%", a.innerSize || 0], q = Math.min(v, t), f, e;
    ...
    (function (a) {
        var B = a.addEvent, A = a.CenteredSeriesMixin, G = a.defined, m = a.extend, g = A.getStartAndEndRadians,
            t = a.noop, u = a.pick, v = a.Point, y = a.Series, q = a.seriesType, f = a.setAnimation;
        q("pie", "line", {
            center: [null, null],
            clip: !1,
            colorByPoint: !0,
            ...
            animate: function (a) {
                var e = this, f = e.points, b = e.startAngleRad;
                a || (f.forEach(function (a) {
                    var f = a.graphic, d = a.shapeArgs;
                    f && (f.attr({r: a.startR || e.center[3] / 2, start: b, end: b}),
                        f.animate({r: d.r, start: d.start, end: d.end}, e.options.animation))
                }), e.animate = null)
            },
            updateTotals: function () {
                var a, f = 0, g = this.points, b = g.length, l, n = this.options.ignoreHiddenPoint;
            ...
            translate: function (a) {
                this.generatePoints();
                var e = 0, f = this.options, b = f.slicedOffset, l = b + (f.borderWidth || 0), n, d,
                    w = g(f.startAngle, f.endAngle), q = this.startAngleRad = w.start,
                    w = (this.endAngleRad = w.end) - q, m = this.points, t, c, k = f.dataLabels.distance,
                    f = f.ignoreHiddenPoint, x, D = m.length, h;
            ...
            drawGraph: null,
            drawPoints: function () {
                var a = this, f = a.chart, g = f.renderer, b, l, n, d,
                    w = a.options.shadow;
            ...
            init: function () {
                ...
                var e = this, b = e.series, g = b.chart, n = b.options.ignoreHiddenPoint;
                f = u(f, n);
                ...
                fixedOffset: function (a, f, g) {
                    ...
                    f = f.touchingSliceAt;
                    var b = this.series, l = b.center[0], n = b.chart.plotWidth, d = b.chart.plotLeft, b = e.alignment,
                        w = this.shapeArgs.r;
                ...
                var a = this.labelPosition, f = this.series.options.dataLabels, g = f.connectorShape,
    ...
    (function (a) {
        var B = a.addEvent, A = a.arrayMax, G = a.defined,
            m = a.extend, g = a.format, t = a.merge, u = a.noop, v = a.pick, y = a.relativeLength, q = a.Series,
            f = a.seriesTypes, e = a.stableSort, p = a.isArray, r = a.splat;
        ...
        q.prototype.drawDataLabels = function () {
            ...
            function e(a, c) {
                ...
                if (p(a) && !p(c)) b = a.map(function (a) {
                    ...
                    return t(a, c)
                }); else if (p(a) || p(c)) for (d = Math.max(a.length, c.length); d--;) b[d] = t(a[d], c[d]); else b = t(a, c);
                return b
            }

            var f = this, d = f.chart, q = f.options, m = q.dataLabels, C = f.points, u, c = f.hasRendered || 0, k,
                x = v(m.defer, !!q.animation), D = d.renderer,
            ...
            if (p(m) ||
                m.enabled || f._hasPointLabels) k = f.plotGroup("dataLabelsGroup", "data-labels", x && !c ? "hidden" : "visible", m.zIndex || 6), x && (k.attr({opacity: +c}), c || B(f, "afterAnimate", function () {
                f.visible && k.show(!0);
                ...
                u.forEach(function (h, e) {
                    var l = h.enabled && !c.isNull && b(c, h), n, p, x, w,
                        m = c.dataLabels ? c.dataLabels[e] : c.dataLabel,
                        r = c.connectors ? c.connectors[e] : c.connector, E = !m;
        ...
        q.prototype.alignDataLabel = function (a, e, f, d, g) {
            var b = this.chart, l = this.isCartesian && b.inverted, n = v(a.dlBox && a.dlBox.centerX, a.plotX, -9999),
                c = v(a.plotY,
                    -9999), k = e.getBBox(), p, q = f.rotation, h = f.align,
            ...
            if (w && (p = b.renderer.fontMetrics(b.styledMode ? void 0 : f.style.fontSize, e).b, d = m({
                ...
                width: 0,
                height: 0
            }, d), m(f, {width: k.width, height: k.height}), q ? (r = !1, n = b.renderer.rotCorr(p, q), n = {
                x: d.x + f.x + d.width / 2 + n.x, y: d.y + f.y + {top: 0, middle: .5, bottom: 1}[f.verticalAlign] *
                    d.height
            }, e[g ? "attr" : "animate"](n).attr({align: h}), c = (q + 720) % 360, c = 180 < c && 360 > c, "left" === h ? n.y -= c ? k.height : 0 : "center" === h ? (n.x -= k.width / 2, n.y -= k.height / 2) : "right" === h && (n.x -= k.width, n.y -= c ? 0 : k.height), e.placed = !0, e.alignAttr = n) : (e.align(f, null, d), n = e.alignAttr), r && 0 <= d.height ? a.isLabelJustified = this.justifyDataLabel(e, f, n, k, d, g) : v(f.crop, !0) && (w = b.isInsidePlot(n.x, n.y) && b.isInsidePlot(n.x + k.width, n.y + k.height)), f.shape && !q)) e[g ? "attr" : "animate"]({
                anchorX: l ? b.plotWidth - a.plotY : a.plotX, anchorY: l ? b.plotHeight -
                    a.plotX : a.plotY
            });
            w || (e.attr({y: -9999}), e.placed = !1)
        };
        q.prototype.justifyDataLabel = function (a, e, f, d, g, p) {
            var b = this.chart, l = e.align, c = e.verticalAlign, k, n, q = a.box ? 0 : a.padding || 0;
            k = f.x + q;
        ...
        f.pie && (f.pie.prototype.dataLabelPositioners = {
            ...
            function () {
                var b = this, e = b.data, f, d = b.chart, g = b.options.dataLabels, p = g.connectorPadding,
                    m = v(g.connectorWidth, 1), r = d.plotWidth, c = d.plotHeight, k = d.plotLeft,
                    x = Math.round(d.chartWidth / 3), t, h = b.center, z = h[2] / 2, u = h[1], y, B, I, O, R = [[], []],
                    K, S, H, T, P = [0, 0, 0, 0], U = b.dataLabelPositioners;
                b.visible && (g.enabled || b._hasPointLabels) && (e.forEach(function (a) {
                    ...
                    e.forEach(function (a) {
                        a.dataLabel && (a.visible ? (R[a.half].push(a), a.dataLabel._pos = null, !G(g.style.width) && !G(a.options.dataLabels && a.options.dataLabels.style && a.options.dataLabels.style.width) && a.dataLabel.getBBox().width > x && (a.dataLabel.css({width: .7 * x}), a.dataLabel.shortened = !0)) : (a.dataLabel = a.dataLabel.destroy(), a.dataLabels && 1 === a.dataLabels.length && delete a.dataLabels))
                    }), R.forEach(function (e, l) {
                    var n, q, x = e.length, m = [], w;
                    if (x) for (b.sortByAngle(e, l - .5), 0 < b.maxLabelDistance && (n = Math.max(0, u - z -
            ...
            var b = this.center, e = this.options, d = e.center, f = e.minSize || 80, g, p = null !== e.size;
        ...
        f.column && (f.column.prototype.alignDataLabel = function (a, e, f, d, g) {
            var b = this.chart.inverted, l = a.series, n = a.dlBox || a.shapeArgs,
            ...
            n && (d = t(n), 0 > d.y && (d.height += d.y, d.y = 0), n = d.y + d.height - l.yAxis.len, 0 < n && (d.height -= n), b && (d = {
                ...
                y: l.xAxis.len - d.x - d.width, width: d.height, height: d.width
    ...
    (function (a) {
        var B = a.Chart, A = a.isArray, G = a.objectEach, m = a.pick, g = a.addEvent, t = a.fireEvent;
        g(B, "render", function () {
            var a = [];
            (this.labelCollectors ||
                []).forEach(function (g) {
        ...
        B.prototype.hideOverlappingLabels = function (a) {
            var g = this, m = a.length, q = g.renderer, f, e, p, r, b, l, n = function (a, b, e, f, g, c, k, l) {
            ...
            p = function (a) {
                ...
                if (a && (!a.alignAttr || a.placed)) return b = a.alignAttr || {
                    ...
                    x: b.x + (d.translateX || 0) + f, y: b.y + (d.translateY ||
                        0) + f - e, width: a.width - 2 * f, height: a.height - 2 * f
                }
            };
            ...
            for (e = 0; e < m; e++) for (l = (p = a[e]) && p.absoluteBox, f = e + 1; f < m; ++f) if (b = (r = a[f]) && r.absoluteBox, l && b && p !== r && 0 !== p.newOpacity && 0 !== r.newOpacity && (b = n(l.x, l.y, l.width, l.height, b.x, b.y, b.width, b.height))) (p.labelrank < r.labelrank ? p : r).newOpacity = 0;
            a.forEach(function (a) {
                var b, d;
                a && (d = a.newOpacity, a.oldOpacity !== d && (a.alignAttr &&
                a.placed ? (d ? a.show(!0) : b = function () {
                    a.hide()
                }, a.alignAttr.opacity = d, a[a.isOld ? "animate" : "attr"](a.alignAttr, null, b), t(g, "afterHideOverlappingLabels")) : a.attr({opacity: d})), a.isOld = !0)
            })
        }
    })(H);
    (function (a) {
        var B = a.addEvent, A = a.Chart, G = a.createElement, m = a.css, g = a.defaultOptions, t = a.defaultPlotOptions,
            u = a.extend, v = a.fireEvent, y = a.hasTouch, q = a.isObject, f = a.Legend, e = a.merge, p = a.pick,
            r = a.Point, b = a.Series, l = a.seriesTypes, n = a.svg, d;
        d = a.TrackerMixin = {
            drawTrackerPoint: function () {
                ...
                var a = this, b = a.options, d = b.trackByArea, e = [].concat(d ? a.areaPath : a.graphPath),
                    c = e.length, k = a.chart, f = k.pointer, g = k.renderer, h = k.options.tooltip.snap, l = a.tracker,
                    p, q = function () {
                        if (k.hoverSeries !== a) a.onMouseOver()
                    }, m = "rgba(192,192,192," + (n ? .0001 : .002) + ")";
                if (c && !d) for (p = c + 1; p--;) "M" === e[p] && e.splice(p + 1, 0, e[p + 1] - h, e[p + 2], "L"), (p && "M" === e[p] || p === c) && e.splice(p, 0, "L", e[p - 2] + h, e[p - 1]);
                l ? l.attr({d: e}) : a.graph && (a.tracker = g.path(e).attr({
        ...
        u(f.prototype, {
            setItemEvents: function (a, b, d) {
                var f = this, c = f.chart.renderer.boxWrapper,
        ...
        u(A.prototype, {
            showResetZoom: function () {
                ...
                var b = this, d = g.lang, e = b.options.chart.resetZoomButton, c = e.theme, k = c.states,
            ...
            pan: function (a, b) {
                ...
                v(this, "pan", {originalEvent: a}, function () {
                    ...
                    ("xy" === b ? [1, 0] : [1]).forEach(function (b) {
                        b = d[b ? "xAxis" : "yAxis"][0];
                        var k = b.horiz, e = a[k ? "chartX" : "chartY"], k = k ? "mouseDownX" : "mouseDownY", h = d[k],
                            f = (b.pointRange || 0) / 2,
                            g = b.reversed && !d.inverted || !b.reversed && d.inverted ? -1 : 1, l = b.getExtremes(),
                            n = b.toValue(h - e, !0) + f * g, g = b.toValue(h + b.len - e, !0) - f * g, p = g < n,
                            h = p ? g : n, n = p ? n : g,
                        ...
                        p = n - f;
                        0 < p && (n = f, h -= p);
                        b.series.length && h !== l.min && n !== l.max && (b.setExtremes(h, n, !1, !1, {trigger: "pan"}), c = !0);
                        d[k] = e
                    });
                    c && d.redraw(!1);
        ...
        u(r.prototype, {
            select: function (a, b) {
                var d = this, e = d.series, c = e.chart;
                a = p(a, !d.selected);
                ...
                if (!this.hasImportedEvents) {
                    var b = this, d = e(b.series.options.point, b.options).events;
                    b.events = d;
                ...
                var d = Math.floor(this.plotX), e = this.plotY, c = this.series,
                    k = c.options.states[a || "normal"] || {}, f = t[c.type].marker && c.options.marker,
                    g = f && !1 === f.enabled, h = f && f.states && f.states[a || "normal"] || {}, l = !1 === h.enabled,
                    n = c.stateMarkerGraphic, q = this.marker || {}, m = c.chart,
                    r = c.halo, w, E = f && c.markerAttribs;
                a = a || "";
                if (!(a === this.state && !b || this.selected && "select" !== a || !1 === k.enabled || a && (l || g && !1 === h.enabled) || a && q.states && q.states[a] && !1 === q.states[a].enabled)) {
                    ...
                    if (this.graphic) this.state && this.graphic.removeClass("highcharts-point-" + this.state), a && this.graphic.addClass("highcharts-point-" + a), m.styledMode || this.graphic.animate(c.pointAttribs(this, a), p(m.options.chart.animation, k.animation)), w && this.graphic.animate(w, p(m.options.chart.animation,
                        h.animation, f.animation)), n && n.hide(); else {
                        if (a && h) {
                            f = q.symbol || c.symbol;
                    ...
                    (d = k.halo) && d.size ? (r || (c.halo = r = m.renderer.path().add((this.graphic || n).parentGroup)), r.show()[b ? "animate" :
                        "attr"]({d: this.haloPath(d.size)}), r.attr({
                    ...
                    }, d.attributes))) : r && r.point && r.point.haloPath && r.animate({d: r.point.haloPath(0)}, null, r.hide);
                    this.state = a;
        ...
        u(b.prototype, {
            onMouseOver: function () {
                ...
                var b = this, d = b.options, e = b.graph,
                    c = d.states, k = d.lineWidth, d = 0;
                a = a || "";
                if (b.state !== a && ([b.group, b.markerGroup, b.dataLabelsGroup].forEach(function (c) {
                    c && (b.state && c.removeClass("highcharts-series-" + b.state), a && c.addClass("highcharts-series-" + a))
                }), b.state = a, !(b.chart.styledMode || c[a] && !1 === c[a].enabled) && (a && (k = c[a].lineWidth || k + (c[a].lineWidthPlus || 0)), e && !e.dashstyle))) for (k = {"stroke-width": k}, e.animate(k, p(c[a || "normal"] && c[a || "normal"].animation, b.chart.options.chart.animation)); b["zone-graph-" + d];) b["zone-graph-" + d].attr(k),
                    d += 1
            }, setVisible: function (a, b) {
                var d = this, e = d.chart, c = d.legendItem, k, f = e.options.chart.ignoreHiddenSeries, g = d.visible;
    ...
    (function (a) {
        var B = a.Chart, A = a.isArray, G = a.isObject, m = a.pick, g = a.splat;
        B.prototype.setResponsive = function (g, m) {
            var t =
                this.options.responsive, u = [], q = this.currentResponsive;
        ...
        B.prototype.currentOptions = function (m) {
            function t(m, q, f, e) {
                ...
                a.objectEach(m, function (a, b) {
                    if (!e && -1 < ["series", "xAxis", "yAxis"].indexOf(b)) for (a = g(a), f[b] = [], p = 0; p < a.length; p++) q[b][p] &&
                    (f[b][p] = {}, t(a[p], q[b][p], f[b][p], e + 1)); else G(a) ? (f[b] = A(a) ? [] : {}, t(a, q[b] || {}, f[b], e + 1)) : f[b] = q[b] || null
                })
            }
    ...
    (function (a) {
        var B = a.addEvent, A = a.Axis, G = a.Chart, m = a.css, g = a.defined, t = a.extend, u = a.noop, v = a.pick,
            y = a.timeUnits;
        ...
        A.prototype.getTimeTicks = function (a, f, e, p, m, b, l) {
            var n = 0, d, q, r = {}, t, v, c, k = [], x = -Number.MAX_VALUE, D = this.options.tickPixelInterval,
                h = this.chart.time,
                z = [];
        ...
        t(A.prototype, {
            beforeSetTickPositions: function () {
                var a, f = [], e, g = !1, m, b = this.getExtremes(), l = b.min, n = b.max, d,
                    w = this.isXAxis && !!this.options.breaks,
                    b = this.options.ordinal, t = Number.MAX_VALUE, u = this.chart.options.chart.ignoreHiddenSeries, y;
                if (b || w) {
                ...
                if (e) {
                    var g = this.ordinalSlope,
                        m = this.ordinalOffset, b = e.length - 1, l;
                    if (f) 0 > a ? a = e[0] : a > b ? a = e[b] : (b = Math.floor(a), l = a - b); else for (; b--;) if (f = g * b + m, a >= f) {
                        g = g * (b + 1) + m;
                        l = (a - f) / (g - f);
                        break
                    }
                ...
                var a = this, f = a.chart, e = a.series[0].currentDataGrouping, g = a.ordinalIndex,
                    m = e ? e.count + e.unitName : "raw", b = a.options.overscroll, l = a.getExtremes(), n, d;
                g || (g = a.ordinalIndex = {});
                g[m] || (n = {
                    series: [], chart: f, getExtremes: function () {
                        return {
                            min: l.dataMin, max: l.dataMax +
                                b
                        }
                    }, options: {ordinal: !0}, val2lin: A.prototype.val2lin, ordinal2lin: A.prototype.ordinal2lin
                ...
                var g =
                    this.options.overscroll, f = this.overscrollPointsRange, e = [], p = this.dataMax;
        ...
        B(G, "pan", function (a) {
            var f = this.xAxis[0], e = f.options.overscroll, g = a.originalEvent.chartX, q = !1;
            if (f.options.ordinal && f.series.length) {
                var b = this.mouseDownX, l = f.getExtremes(), n = l.dataMax, d = l.min, w = l.max, t = this.hoverPoints,
                    v = f.closestPointRange || f.overscrollPointsRange,
                    b = (b - g) / (f.translationSlope * (f.ordinalSlope || v)),
                    u = {ordinalPositions: f.getExtendedPositions()}, v = f.lin2val,
                    c = f.val2lin, k;
                u.ordinalPositions ? 1 < Math.abs(b) && (t && t.forEach(function (a) {
                    a.setState()
                }), 0 > b ? (t = u, k = f.ordinalPositions ? f : u) : (t = f.ordinalPositions ? f : u, k = u), u = k.ordinalPositions, n > u[u.length - 1] && u.push(n), this.fixedRange = w - d, b = f.toFixedRange(null, null, v.apply(t, [c.apply(t, [d, !0]) + b, !0]), v.apply(k, [c.apply(k, [w, !0]) + b, !0])), b.min >= Math.min(l.dataMin, d) && b.max <= Math.max(n, w) + e && f.setExtremes(b.min, b.max, !0, !1, {trigger: "pan"}), this.mouseDownX = g, m(this.container, {cursor: "move"})) : q = !0
            } else q = !0;
            q ? e && (f.max =
    ...
    (function (a) {
        var B = a.addEvent, A = a.pick, G = a.extend, m = a.isArray, g = a.fireEvent, t = a.Axis, u = a.Series;
        G(t.prototype, {
            isInBreak: function (a, g) {
                var m =
                    a.repeat || Infinity, f = a.from, e = a.to - a.from;
                g = g >= f ? (g - f) % m : m - (f - g) % m;
                return a.inclusive ? g <= e : g < e && 0 !== g
            }, isInAnyBreak: function (a, g) {
                var m = this.options.breaks, f = m && m.length, e, p, r;
                if (f) {
        ...
        B(t, "afterSetTickPositions", function () {
            if (this.isBroken) {
                var a = this.tickPositions, g = this.tickPositions.info,
                    m = [], f;
        ...
        t.prototype.setBreaks = function (a, u) {
            ...
            p && (e.userOptions.ordinal = !1, e.val2lin = q, e.lin2val = f, e.setExtremes = function (a, b, e, f, d) {
                ...
                function (a) {
                    ...
                    if (this.isBroken) {
                        a = e.options.breaks;
                        var b = [], f = [], n = 0, d, m, p = e.userMin || e.min, q = e.userMax || e.max,
                            r = A(e.pointRangePadding, 0), c, k;
                        a.forEach(function (a) {
                            m = a.repeat || Infinity;
        ...
        B(u, "afterGeneratePoints", function () {
            var a = this.xAxis, g = this.yAxis, m = this.points, f, e = m.length, p = this.options.connectNulls, r;
            if (a && g && (a.options.breaks || g.options.breaks)) for (; e--;) f = m[e], r = null === f.y && !1 === p, r || !a.isInAnyBreak(f.x, !0) && !g.isInAnyBreak(f.y, !0) || (m.splice(e, 1), this.data[e] && this.data[e].destroyElements())
        });
        ...
        a.Series.prototype.gappedPath = function () {
            var g = this.currentDataGrouping, m = g && g.gapSize, g = this.options.gapSize, q = this.points.slice(),
                f = q.length -
                    1, e = this.yAxis;
            if (g && 0 < f) for ("value" !== this.options.gapUnit && (g *= this.closestPointRange), m && m > g && (g = m); f--;) q[f + 1].x - q[f].x > g && (m = (q[f].x + q[f + 1].x) / 2, q.splice(f + 1, 0, {
                isNull: !0,
                x: m
    ...
    (function (a) {
        var B = a.addEvent, A = a.arrayMax, G = a.arrayMin, m = a.Axis, g = a.defaultPlotOptions, t = a.defined,
            u = a.extend, v = a.format, y = a.isNumber, q = a.merge, f = a.pick, e = a.Point,
            p = a.Series, r = a.Tooltip, b = a.approximations = {
                sum: function (a) {
                    var b = a.length, c;
                ...
                var f = this, h = f.data, k = f.options && f.options.data, g = [], l = [], n = [], m = a.length, p, x,
                    r = !!c, w = [], u = f.pointArrayMap, D = u && u.length, v = ["x"].concat(u || ["y"]), E = 0, C = 0, F,
                    A;
                e = "function" === typeof e ?
                ...
                for (A; A <= m; A++) {
                    for (; void 0 !== d[E + 1] && a[A] >= d[E + 1] || A === m;) {
                        ...
                        x = e.apply(f, w);
                        f.pointClass && !t(f.dataGroupInfo.options) && (f.dataGroupInfo.options = q(f.pointClass.prototype.optionsToObject.call({series: f}, f.options.data[f.cropStart + C])), v.forEach(function (a) {
            ...
            }, n = {approximations: b, groupData: l}, d = p.prototype, w = d.processData, E = d.generatePoints,
            C = {
                groupPixelWidth: 2,
                dateTimeLabelFormats: {
        ...
        d.processData = function () {
            var a = this.chart, b = this.options.dataGrouping,
                ...
                h = this.visible || !a.options.chart.ignoreHiddenSeries, g, l = this.currentDataGrouping, n, m = !1;
            this.forceCrop = e;
            ...
            if (!e) {
                ...
                var p, e = b.groupAll ? this.xData : this.processedXData,
                    q = b.groupAll ? this.yData : this.processedYData, r = a.plotSizeX, a = this.xAxis,
                    u = a.options.ordinal, v = this.groupPixelWidth = a.getGroupPixelWidth && a.getGroupPixelWidth();
                if (v) {
                    this.isDirty = g = !0;
                    this.points = null;
                    m = a.getExtremes();
                    n = m.min;
                    var m = m.max, u = u && a.getGroupIntervalFactor(n, m, this) || 1, v = v * (m - n) / r * u,
                        ...
                        q = d.groupData.apply(this,
                            [e, q, r, b.approximation]), e = q.groupedXData, u = q.groupedYData, E = 0;
        ...
        B(r, "headerFormatter", function (a) {
            var b = this.chart.time, c = a.labelConfig, d = c.series, e = d.tooltipOptions, f = d.options.dataGrouping,
                k = e.xDateFormat, g, l = d.xAxis, n, m = e[(a.isFooter ? "footer" : "header") + "Format"];
        ...
        B(p, "afterSetOptions", function (a) {
            a = a.options;
            var b = this.type, c = this.chart.options.plotOptions, d = g[b].dataGrouping,
        ...
        m.prototype.getGroupPixelWidth = function () {
            var a = this.series, b = a.length, c, d = 0, e = !1, g;
        ...
        m.prototype.setDataGrouping = function (a, b) {
            ...
            a || (a =
                {forced: !1, units: null});
            if (this instanceof m) for (c = this.series.length; c--;) this.series[c].update({dataGrouping: a}, !1); else this.chart.options.series.forEach(function (b) {
                b.dataGrouping = a
            }, !1);
    ...
    (function (a) {
        var B = a.Point, A = a.seriesType, G = a.seriesTypes;
        A("ohlc", "column", {
            lineWidth: 1,
            ...
            translate: function () {
                var a = this, g = a.yAxis, t = !!a.modifyValue,
            ...
            drawPoints: function () {
                ...
                a.points.forEach(function (m) {
                    var t, v, y, q, f = m.graphic, e, p = !f;
                    void 0 !==
                    m.plotY && (f || (m.graphic = f = g.renderer.path().add(a.group)), g.styledMode || f.attr(a.pointAttribs(m, m.selected && "select")), v = f.strokeWidth() % 2 / 2, e = Math.round(m.plotX) - v, y = Math.round(m.shapeArgs.width / 2), q = ["M", e, Math.round(m.yBottom), "L", e, Math.round(m.plotHigh)], null !== m.open && (t = Math.round(m.plotOpen) + v, q.push("M", e, t, "L", e - y, t)), null !== m.close && (t = Math.round(m.plotClose) + v, q.push("M", e, t, "L", e + y, t)), f[p ? "attr" : "animate"]({d: q}).addClass(m.getClassName(), !0))
                })
            },
            animate: null
        }, {
    ...
    (function (a) {
        var B = a.defaultPlotOptions, A = a.merge, G = a.seriesType, m = a.seriesTypes;
        G("candlestick", "ohlc", A(B.column, {
            ...
            pointAttribs: function (a, t) {
                var g = m.column.prototype.pointAttribs.call(this, a, t), v = this.options, y = a.open < a.close,
                ...
                var a = this, m = a.chart, u = a.yAxis.reversed;
                a.points.forEach(function (g) {
                    var t = g.graphic, q, f, e, p, r, b, l, n = !t;
    ...
    da = function (a) {
        var B = a.defined, A = a.seriesTypes, G = a.stableSort;
        return {
            getPlotBox: function () {
                ...
                var a = this, g = a.options, t = a.chart, u = a.points, v = u.length - 1, y, q = g.onSeries,
                    q = q && t.get(q), g = g.onKey || "y", f = q && q.options.step, e = q && q.points,
                    p = e && e.length, r = t.inverted, b = a.xAxis, l = a.yAxis, n = 0, d, w, E, C;
                if (q && q.visible && p) for (n = (q.pointXOffset ||
    ...
    (function (a, B) {
        ...
        var G = a.addEvent, m = a.merge,
            g = a.noop, t = a.defined, u = a.Renderer, v = a.Series, y = a.seriesType, q = a.TrackerMixin,
            f = a.VMLRenderer, e = a.SVGRenderer.prototype.symbols;
        y("flags", "column", {
            pointRange: 0,
            allowOverlapX: !1,
            shape: "flag",
            ...
            forceCrop: !0, init: v.prototype.init, pointAttribs: function (a, e) {
                var b = this.options, f = a && a.color || this.color, g = b.lineColor, d = a && a.lineWidth;
            ...
            }, translate: B.translate, getPlotBox: B.getPlotBox, drawPoints: function () {
                var e = this.points, f = this.chart, b = f.renderer, g, n, d = f.inverted, q = this.options, u = q.y, v,
                    y, c, k, x, D, h = this.yAxis, z = {}, A = [];
                for (y = e.length; y--;) c =
                ...
                c.graphic.div && (c.graphic.div.point = c), f.styledMode || k.shadow(q.shadow), k.isNew = !0), 0 < g && (g -= k.strokeWidth() % 2), v = {
                    y: n,
                    anchorY: x
                }, q.allowOverlapX && (v.x = g, v.anchorX = c.anchorX), k.attr({text: c.options.title || q.title || "A"})[k.isNew ? "attr" : "animate"](v), q.allowOverlapX || (z[c.plotX] ? z[c.plotX].size = Math.max(z[c.plotX].size, k.width) : z[c.plotX] = {
                    align: 0,
                    size: k.width,
                    target: g,
                    anchorX: g
    ...
    (function (a) {
        ...
        var A = a.addEvent, G = a.Axis, m = a.correctFloat, g = a.defaultOptions, t = a.defined,
            u = a.destroyObjectProperties, v = a.fireEvent, y = a.hasTouch, q = a.merge, f = a.pick, e = a.removeEvent,
            p, r = {
        ...
        B.prototype = {
            init: function (a, e, g) {
                ...
                var b = this.options.vertical,
                    g = 0, l = this.rendered ? "animate" : "attr";
                this.x = a;
                ...
                var b =
                    this.renderer, e = this.scrollbarButtons, d = this.options, f = this.size, g;
                ...
                var b = this.options, d = b.vertical, f = b.minWidth, g = this.barWidth, l, p,
                    c = !this.rendered || this.hasDragged || this.chart.navigator && this.chart.navigator.hasDragged ? "attr" : "animate";
                t(g) && (a = Math.max(a, 0), l = Math.ceil(g * a), this.calculatedWidth = p = m(g * Math.min(e, 1) - l), p < f && (l = (g - f + p) * a, p = f), f = Math.floor(l + this.xOffset + this.yOffset), g = p / 2 - .5, this.from = a, this.to = e, d ? (this.scrollbarGroup[c]({translateY: f}), this.scrollbar[c]({height: p}),
                    this.scrollbarRifles[c]({translateY: g}), this.scrollbarTop = f, this.scrollbarLeft = 0) : (this.scrollbarGroup[c]({translateX: f}), this.scrollbar[c]({width: p}), this.scrollbarRifles[c]({translateX: g}), this.scrollbarLeft = f, this.scrollbarTop = 0), 12 >= p ? this.scrollbarRifles.hide() : this.scrollbarRifles.show(!0), !1 === b.showFull && (0 >= a && 1 <= e ? this.group.hide() : this.group.show()), this.rendered = !0)
            }, initEvents: function () {
                var a = this;
                a.mouseMoveHandler = function (b) {
                    var e = a.chart.pointer.normalize(b), d = a.options.vertical ?
                ...
                a.trackClick = function (b) {
                    var e = a.chart.pointer.normalize(b),
                        d = a.to - a.from, f = a.y + a.scrollbarTop, g = a.x + a.scrollbarLeft;
                ...
                var a = this.options.inverted ? [1, 0] : [0, 1], e = this.scrollbarButtons,
                    f = this.scrollbarGroup.element, d = this.mouseDownHandler, g = this.mouseMoveHandler,
                    m = this.mouseUpHandler,
                    a = [[e[a[0]].element, "click", this.buttonToMinClick], [e[a[1]].element, "click", this.buttonToMaxClick], [this.track.element, "click", this.trackClick], [f,
                        "mousedown", d], [f.ownerDocument, "mousemove", g], [f.ownerDocument, "mouseup", m]];
        ...
        A(G, "afterInit", function () {
            ...
            b.options && b.options.scrollbar && b.options.scrollbar.enabled && (b.options.scrollbar.vertical = !b.horiz, b.options.startOnTick = b.options.endOnTick = !1, b.scrollbar = new B(b.chart.renderer, b.options.scrollbar, b.chart), A(b.scrollbar, "changed", function (e) {
                var g = Math.min(f(b.options.min, b.min), b.min, b.dataMin),
                    d = Math.max(f(b.options.max, b.max), b.max, b.dataMax) - g, l;
                b.horiz &&
        ...
        A(G, "afterRender", function () {
            var a = Math.min(f(this.options.min, this.min), this.min, f(this.dataMin, this.min)),
                e = Math.max(f(this.options.max, this.max), this.max, f(this.dataMax, this.max)), g = this.scrollbar,
        ...
        A(G, "afterGetOffset", function () {
            var a = this.horiz ? 2 : 1, e = this.scrollbar;
    ...
    (function (a) {
        ...
        var A = a.addEvent, G = a.Axis, m = a.Chart, g = a.color, t = a.defaultOptions, u = a.defined,
            v = a.destroyObjectProperties,
            y = a.erase, q = a.extend, f = a.hasTouch, e = a.isArray, p = a.isNumber, r = a.isTouchDevice, b = a.merge,
            l = a.pick, n = a.removeEvent, d = a.Scrollbar, w = a.Series, E = a.seriesTypes,
            C = [].concat(a.defaultDataGroupingUnits), F = function (a) {
        ...
        q(t, {
            navigator: {
                ...
                maskInside: !0,
                handles: {
                    width: 7, height: 15, symbols: ["navigator-handle", "navigator-handle"], enabled: !0,
                    lineWidth: 1, backgroundColor: "#f2f2f2", borderColor: "#999999"
                },
        ...
        B.prototype = {
            drawHandle: function (a, b, d, e) {
                ...
                var c = this.navigatorOptions.maskInside, f = this.outline.strokeWidth(), g = f / 2, f = f % 2 / 2,
                    k = this.outlineHeight,
                    l = this.scrollbarHeight, n = this.size, m = this.left - l, p = this.top;
                ...
                var c = this.left, f = this.top, g = this.height, k, l, n, m;
                d ? (n = [c, c, c], m = [f, f + a, f + b], l = [g, g, g], k = [a, b - a, this.size - b]) : (n = [c, c + a, c + b], m = [f, f, f], l =
                    [a, b - a, this.size - b], k = [g, g, g]);
                this.shades.forEach(function (a, c) {
                    a[e]({x: n[c], y: m[c], width: l[c], height: k[c]})
                })
            }, renderElements: function () {
                var a = this, b = a.navigatorOptions, d = b.maskInside, e = a.chart, f = e.renderer, g,
                ...
                var f = this.chart, g, k, n = this.scrollbarHeight, m, q = this.xAxis;
                g = q.fake ? f.xAxis[0] : q;
                var r = this.navigatorEnabled, x, t = this.rendered;
                k = f.inverted;
                var w,
                    v = f.xAxis[0].minRange, D = f.xAxis[0].options.maxRange;
                if (!this.hasDragged || u(d)) {
                    ...
                    r && (this.navigatorGroup.attr({visibility: "visible"}), t = t && !this.hasDragged ? "animate" : "attr", this.drawMasks(d, x, k, t), this.drawOutline(d, x, k, t), this.navigatorOptions.handles.enabled &&
                ...
                var a = this, b = a.chart, d = b.container, e = [], g, l;
                ...
                var c = this, d = c.chart, e = c.left, f = c.navigatorSize, g = c.range, n = c.dragOffset,
                    m = d.inverted;
                b.touches &&
                ...
                var b = this.chart,
                    c = this.xAxis, d = this.scrollbar, e, f, g = a.DOMEvent || a;
                ...
                var c = a.options, e = c.navigator, f = e.enabled, g = c.scrollbar, n = g.enabled, c = f ? e.height : 0,
                    m = n ? g.height : 0;
                this.handles = [];
                this.shades = [];
                this.chart = a;
                ...
                var p = this, f = p.baseSeries, g = a.xAxis.length, n = a.yAxis.length,
                ...
                p.navigatorEnabled ? (p.xAxis = new G(a, b({
                    ...
                    offsets: [m,
                        0, -m, 0], width: c
                } : {offsets: [0, -m, 0, m], height: c})), p.yAxis = new G(a, b(e.yAxis, {
                    id: "navigator-y-axis",
                    alignTicks: !1,
                    offset: 0,
                    index: n,
                    isInternal: !0,
                    zoomEnabled: !1
                }, a.inverted ? {width: c} : {height: c})), f || e.series.data ? p.updateNavigatorSeries(!1) : 0 === a.series.length && (p.unbindRedraw = A(a, "beforeRedraw", function () {
                ...
                })), p.reversedExtremes = a.inverted && !p.xAxis.reversed || !a.inverted && p.xAxis.reversed, p.renderElements(), p.addMouseEvents()) : p.xAxis =
                    {
                        translate: function (b, c) {
                            var d = a.xAxis[0], e = d.getExtremes(), f = d.len - 2 * m,
                                g = F("min", d.options.min, e.dataMin), d = F("max", d.options.max, e.dataMax) - g;
            ...
            setBaseSeries: function (b, d) {
                ...
                var a = this.chart.navigator, b = this.getExtremes(), d = b.dataMin, e = b.dataMax, b = b.max - b.min,
                    f = a.stickToMin, g = a.stickToMax, n = l(this.options.overscroll, 0), m, q,
                    r = a.series && a.series[0], t = !!this.setExtremes;
                ...
                var a = this.chart.navigator, b = this.navigatorSeries, d = a.getBaseSeriesMin(this.xData[0]);
        ...
        A(m, "beforeShowResetZoom", function () {
            var a = this.options, b = a.navigator, d = a.rangeSelector;
        ...
        A(m, "afterSetChartSize", function () {
            var a = this.legend, b = this.navigator, d, e, f, g;
        ...
        A(m, "update", function (a) {
            var c = a.options.navigator || {}, d = a.options.scrollbar || {};
    ...
    (function (a) {
        ...
        var A = a.addEvent, G = a.Axis, m = a.Chart, g = a.css, t = a.createElement, u = a.defaultOptions,
            v = a.defined, y = a.destroyObjectProperties, q = a.discardElement, f = a.extend, e = a.fireEvent,
            p = a.isNumber, r = a.merge, b = a.pick, l = a.pInt, n = a.splat;
        f(u, {
            rangeSelector: {
                verticalAlign: "top",
        ...
        B.prototype = {
            clickButton: function (a, e) {
                var d = this.chart, f = this.buttonOptions[a], g = d.xAxis[0],
                    c = d.scroller && d.scroller.getUnionExtremes() || g || {}, k = c.dataMin, l = c.dataMax, m,
                    h = g && Math.round(Math.min(g.max, b(l, g.max))), q = f.type, r, c = f._range, t, w, u,
                    v = f.dataGrouping;
                if (null !== k && null !== l) {
                    d.fixedRange = c;
                    v && (this.forcedDataGrouping = !0, G.prototype.setDataGrouping.call(g || {chart: this.chart},
                    ...
                    if ("month" === q || "year" === q) g ? (q = {
                        ...
                        dataMin: k,
                        dataMax: l
                    }, m = g.minFromRange.call(q), p(q.newMax) && (h = q.newMax)) : c = f; else if (c) m = Math.max(h - c, k), h = Math.min(m + c, l); else if ("ytd" === q) if (g) void 0 === l && (k = Number.MAX_VALUE, l = Number.MIN_VALUE, d.series.forEach(function (a) {
                        a = a.xData;
                        k = Math.min(a[0], k);
            ...
            init: function (a) {
                var b = this, d = a.options.rangeSelector, f = d.buttons || [].concat(b.defaultButtons), g = d.selected,
                    c = function () {
            ...
            updateButtonStates: function () {
                var a = this, b = this.chart, e = b.xAxis[0], f = Math.round(e.max - e.min), g = !e.hasVisibleSeries,
                    c = b.scroller && b.scroller.getUnionExtremes() || e, k = c.dataMin, l = c.dataMax,
                    b = a.getYTDExtremes(l, k, b.time.useUTC), m = b.min, h = b.max, n = a.selected, q = p(n),
                    r = a.options.allButtonsEnabled, t = a.buttons;
                a.buttonOptions.forEach(function (b,
                                                  c) {
                    var d = b._range, p = b.type, w = b.count || 1, x = t[c], u = 0, v = b._offsetMax - b._offsetMin;
                    b = c === n;
                    var z = d > l - k, y = d < e.minRange, E = !1, C = !1, d = d === f;
            ...
            showInput: function (a) {
                var b = this.inputGroup, d = this[a + "DateBox"];
                g(this[a + "Input"], {
            ...
            drawInput: function (b) {
                function d() {
                    var a = h.value, b = (k.inputDateParser || Date.parse)(a), c = m.xAxis[0],
                        d = m.scroller && m.scroller.xAxis ? m.scroller.xAxis : c, f = d.dataMin, d = d.dataMax;
                    b !== h.previousValue && (h.previousValue = b, p(b) || (b = a.split("-"), b = Date.UTC(l(b[0]), l(b[1]) - 1, l(b[2]))), p(b) && (m.time.useUTC || (b += 6E4 * (new Date).getTimezoneOffset()), v ? b > e.maxInput.HCTime ? b = void 0 : b < f && (b = f) : b < e.minInput.HCTime ? b = void 0 : b > d && (b = d), void 0 !== b && c.setExtremes(v ? b : c.min, v ? c.max : b, void 0, void 0, {trigger: "rangeSelectorInput"})))
                }

                var e = this, m = e.chart, n = m.renderer.style || {}, c = m.renderer, k = m.options.rangeSelector,
                    q = e.div, v = "min" === b, h, z, y = this.inputGroup;
                ...
                this[b + "Input"] = h = t("input", {
                    name: b,
                    className: "highcharts-range-selector", type: "text"
                }, {top: m.plotTop + "px"}, q);
                m.styledMode || (z.css(r(n, k.labelStyle)), c.css(r({color: "#333333"}, n, k.inputStyle)), g(h, f({
                    position: "absolute",
                    border: 0,
                    width: "1px",
                    height: "1px",
            ...
            getPosition: function () {
                var a =
                        this.chart, b = a.options.rangeSelector,
            ...
            getYTDExtremes: function (a, b, e) {
                var d = this.chart.time, f = new d.Date(a), c = d.get("FullYear", f);
            ...
            render: function (a, e) {
                var d = this, f = d.chart, g = f.renderer, c = f.container, k = f.options,
                    l = k.exporting && !1 !== k.exporting.enabled && k.navigation && k.navigation.buttonOptions,
                    m = u.lang, h = d.div, n = k.rangeSelector, p = b(k.chart.style && k.chart.style.zIndex, 0) + 1,
                    k = n.floating, q = d.buttons, h = d.inputGroup, r = n.buttonTheme, w = n.buttonPosition,
                    v = n.inputPosition, y = n.inputEnabled, A = r && r.states, B = f.plotLeft, G, H = d.buttonGroup, P;
                P = d.rendered;
                var U = d.options.verticalAlign, ca = f.legend, M = ca && ca.options, V = w.y, N = v.y, Q = P || !1,
                    X = Q ? "animate" : "attr", ba = 0, Z = 0, Y;
                if (!1 !== n.enabled) {
                    P || (d.group = P = g.g("range-selector-group").attr({zIndex: 7}).add(), d.buttonGroup = H = g.g("range-selector-buttons").add(P), d.zoomText =
                        ...
                        q[b] = g.button(a.text, 0, 0, function () {
                            var c = a.events && a.events.click, e;
                            c && (e = c.call(a));
                            !1 !== e && d.clickButton(b);
                            d.isActive = !0
                        }, r, A && A.hover, A && A.select, A && A.disabled).attr({"text-align": "center"}).add(H)
                    ...
                    H.align({
                        y: w.y, width: H.getBBox().width, align: w.align,
                        x: Y
                    }, !0, f.spacingBox);
                    d.group.placed = Q;
                    ...
                    if ("top" ===
                        U) k && (Z = 0), f.titleOffset && (Z = f.titleOffset + f.options.title.margin), Z += f.margin[0] - f.spacing[0] || 0; else if ("middle" === U) if (N === V) Z = 0 > N ? e + void 0 : e; else if (N || V) Z = 0 > N || 0 > V ? Z - Math.min(N, V) : e - a + NaN;
            ...
            getHeight: function () {
                var a = this.options, b = this.group, e = a.y, f = a.buttonPosition.y, a = a.inputPosition.y,
                    b = b ? b.getBBox(!0).height + 13 + e : 0, e = Math.min(a,
                    f);
            ...
            destroy: function () {
                var b = this, e = b.minInput, f = b.maxInput;
                b.unMouseDown();
                b.unResize();
                y(b.buttons);
        ...
        G.prototype.minFromRange = function () {
            var a = this.range, e = {month: "Month", year: "FullYear"}[a.type], f, g = this.max, l, c,
                k = function (a, b) {
                    var c = new Date(a), d = c["get" + e]();
                    c["set" + e](d + b);
                    d === c["get" +
                    e]() && c.setDate(0);
                    return c.getTime() - a
    ...
    (function (a) {
        var B = a.addEvent, A = a.arrayMax, G = a.arrayMin, m = a.Axis, g = a.Chart, t = a.defined, u = a.extend,
            v = a.format, y = a.isNumber, q = a.isString, f = a.merge, e = a.pick, p = a.Point, r = a.Renderer,
            b = a.Series, l = a.splat, n = a.SVGRenderer, d = a.VMLRenderer, w = b.prototype, E = w.init,
            C = w.processData, F = p.prototype.tooltipFormatter;
        a.StockChart = a.stockChart = function (b, d, m) {
            var c = q(b) || b.nodeName, h = arguments[c ? 1 : 0], k = h, n = h.series, p = a.getOptions(), r,
                t = e(h.navigator && h.navigator.enabled, p.navigator.enabled, !0),
                u = t ? {startOnTick: !1, endOnTick: !1} : null, x = {marker: {enabled: !1, radius: 2}},
        ...
        B(m, "getPlotLinePath", function (b) {
            ...
            var d = this,
                f = this.isLinked && !this.series ? this.linkedParent.series : this.series, g = d.chart, l = g.renderer,
                m = d.left, n = d.top, p, r, u, v, w = [], A = [], B, C, E = b.translatedValue, G = b.value,
                F = b.force, H;
            if ("xAxis" === d.coll || "yAxis" === d.coll) b.preventDefault(), A = c(d.coll), B = d.isXAxis ? g.yAxis : g.xAxis, B.forEach(function (a) {
                if (t(a.options.id) ? -1 === a.options.id.indexOf("navigator") : 1) {
                    var b = a.isXAxis ? "yAxis" : "xAxis", b = t(a.options[b]) ? g[b][a.options[b]] : g[b][0];
                    d === b && A.push(a)
                }
        ...
        B(m, "afterDrawCrosshair", function (a) {
            ...
            if (t(this.crosshair.label) && this.crosshair.label.enabled &&
                this.cross) {
                var d = this.chart, f = this.options.crosshair.label, g = this.horiz;
                b = this.opposite;
                c = this.left;
                var l = this.top, m = this.crossLabel, n = f.format, p = "", q = "inside" === this.options.tickPosition,
                    r = !1 !== this.crosshair.snap, w = 0, y = a.e || this.cross && this.cross.e, A = a.point;
                a = this.lin2log;
                var B, C;
        ...
        w.processData = function () {
            var a, b = -1, d, e, f = !0 === this.options.compareStart ? 0 : 1, g, l;
            C.apply(this, arguments);
            if (this.xAxis && this.processedYData) for (d = this.processedXData, e = this.processedYData, g = e.length, this.pointArrayMap && (b = this.pointArrayMap.indexOf(this.options.pointValKey || this.pointValKey || "y")), a = 0; a < g - f; a++) if (l = e[a] && -1 < b ? e[a][b] : e[a], y(l) && d[a + f] >= this.xAxis.min && 0 !== l) {
                this.compareValue = l;
                break
            }
        };
        B(b, "afterGetExtremes", function () {
            if (this.modifyValue) {
                var a =
                    [this.modifyValue(this.dataMin), this.modifyValue(this.dataMax)];
                this.dataMin = G(a);
                this.dataMax = A(a)
            }
        });
